...
export const ENGINES={
 ...
 maker_studio:{label:'Maker Studio',image:'/maker/hall.jpg',description:'Get a job, curate a wall from a storage room, write placards and a plaque. About 20 minutes.'},
};
