...
export const ENGINES={
 ...
 broadcast_booth:{label:'Broadcast Booth',image:'/teacher/challenges/newsroom.jpg',description:'Voice-first Field Radio. Students record four short beats with optional stills. Teacher listens — not AI-graded. About 25–30 minutes.'},
};
