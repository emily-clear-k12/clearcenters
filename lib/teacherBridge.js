...
export const ENGINES={
 ...
 maker_studio:{label:'Maker Studio',image:'/teacher/challenges/museum_exhibit.jpg',description:'Prompt plus make modes. Students finish Write, then submit for teacher review — not AI-graded.'},
};
