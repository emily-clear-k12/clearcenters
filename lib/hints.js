...
export const CASE_HINTS = {
  ...
  "SS.3.2B-SC": [
    "Compare the two traffic counts — how many cars pass Elm Street each hour versus Birch Lane? Does that gap explain why the city chose two different fixes?",
    "Signal C says Birch Lane needs the exact same stoplight. Check the safety log and the cost estimate — has Birch Lane actually had a crossing problem?",
  ],
  "SS.3.3A-SC": [
    "Both places had the same weather today — but check the elevation and rainfall records. Do those numbers match too?",
    "Signal C claims the land must be nearly identical. Look at how far apart the two elevations are — does that sound like \"basically the same place\"?",
  ],
  "SS.3.3C-SC": [
    "Count up the change log — how many of this year's changes were caused by weather, and how many by construction crews?",
    "Signal C says every change was natural. Check the road photo and the parking lot photo — who's shown doing the work in each one?",
  ],
  "SS.3.5B-SC": [
    "Add up Maya's four categories on the worksheet — do they reach her full $40, or leave some out?",
    "Signal A is about saving. Check Maya's note — is that $10 spent right away, or set aside for later?",
  ],
  "SS.3.6B-SC": [
    "Signal B mixes glittery and plain notebooks into one big total. Does that total change how few glittery ones are actually left?",
    "Check the waitlist and the restock note for Signal C — has the shelf actually hit zero, or is something else making it scarce?",
  ],
  "SS.3.6C-SC": [
    "Compare the total revenue to the total cost — which number is bigger, and what does that say about selling out?",
    "Signal C is about each cupcake alone. Check the ingredient receipt against the price sign — which one costs more?",
  ],
  "SS.3.7C-SC": [
    "Match each service to its badge or seal — city, state, or federal. Does the mail carrier's record point to a local office?",
    "Signal C claims the city could handle mail delivery. Check the postal service rule — who does federal law say that job belongs to?",
  ],
  "SS.3.8A-SC": [
    "Check each curator's note for when the document was written — before independence, or after, to set up government?",
    "Signal C suggests one shared label works for all three. Look at the comparison note — how many different purposes does it list?",
  ],
  "SS.3.9E-SC": [
    "Check how many students actually voted Aquarium versus how loud that group cheered afterward — do those two numbers match?",
    "Signal C is about what makes a vote fair. Check Room 12's posted rule — what does it say decides the winner?",
  ],
  "SS.4.1B-SC": [
    "Compare the Karankawa's food record to the Caddo's — do a coastal group and a farming group get their food the same way?",
    "Signal C claims all three groups lived about the same. Check the Lipan Apache's shelter and travel records — how different are tipis and following bison from farming in a permanent village?",
  ],
  "SS.4.2A-SC": [
    "Signal A claims curiosity was the main reason. Check Coronado's and La Salle's own expedition records — does either one mention curiosity?",
    "Look at what Coronado was searching for versus what La Salle was trying to claim — are those the same goal, or two different ones?",
  ],
  "SS.4.2C-SC": [
    "Check the mission site record for water — why would builders care about a river running past a mission?",
    "Signal C says sites were picked at random. Look at the site selection record — how many different real reasons does it list?",
  ],
  "SS.4.3D-SC": [
    "Signal A claims Texas's problems were mostly solved after independence. Check the treasury record and Mexico's statement — do either of those sound solved?",
    "Look at the timeline in the historian's note — how many years did these challenges last after 1836?",
  ],
  "SS.4.4B-SC": [
    "Compare the Texas cattle price to the price up north — how big is that gap, and what would that gap alone push ranchers to do?",
    "Signal C says having lots of cattle was the main reason. Check the boom timeline — did the industry take off before or after the new trails opened?",
  ],
  "SS.4.6B-SC": [
    "Compare the soil samples from both regions — does matching weather today mean matching soil too?",
    "Signal C leans on today's weather. Check the regions reference guide — what does it say regions are actually defined by?",
  ],
  "SS.4.9A-SC": [
    "Signal A claims every group relied mainly on hunting. Check the Caddo's farming record — does that sound like hunting?",
    "Compare how the Karankawa and the Lipan Apache got their food — are those the same method?",
  ],
  "SS.4.11C-SC": [
    "Check the growth timeline — did railroads and farmland activity pick up before or after the biggest population jumps?",
    "Signal A is about railroads. Look at the trade volume record — how far were farmers and ranchers suddenly able to ship their goods?",
  ],
  "SS.4.17B-SC": [
    "Compare the instruments listed for each music style — do Conjunto/Tejano and Western/cowboy music use the same ones?",
    "Signal A claims both styles must sound alike. Check each style's origin record — do they trace back to the same cultural roots?",
  ],
  "SS.5.2A-SC": [
    "Check the timeline of laws passed after the Stamp Act — how many years passed between it and Lexington and Concord?",
    "Signal B says loud protest proves war-readiness. Look at the repeal notice — what happened to the Stamp Act just one year after it passed?",
  ],
  "SS.5.4A-SC": [
    "Compare the causes summary to the land treaty map's date — did that treaty even exist yet when the war started?",
    "Signal C is about the War Hawks' land hopes. Check the causes summary — what does it list as the top reasons for declaring war?",
  ],
  "SS.5.4D-SC": [
    "Look closely at the states' rights document — what specific right does it actually defend?",
    "Signal D calls sectionalism 'unrelated' to slavery. Check the economic map — what kind of labor built each region's economy?",
  ],
  "SS.5.4E-SC": [
    "Compare the amendment's text to the sharecropping contract's date — did the contract come before or after 1865?",
    "Signal A calls the amendment 'the finish line.' Check the black codes record — what happened to freed people's rights after 1865?",
  ],
  "SS.5.7B-SC": [
    "Compare the two land surveys — what does each town's soil and water access actually look like?",
    "Signal C points to the founding record's forty families. Check the later census — did that founding crowd turn into a growing town?",
  ],
  "SS.5.8B-SC": [
    "Compare the proposal notice to the flooded farmland record — does the notice mention what happened to that land?",
    "Signal D is about downstream effects. Check the fish population data — what changed after the dam was built?",
  ],
  "SS.5.13B-SC": [
    "Compare the Mayflower Compact and House of Burgesses records — what did colonists actually do in each one?",
    "Signal C is about who could vote. Check the town meeting minutes — did every colonist need to vote for the meetings to count as self-government?",
  ],
  "SS.5.14B-SC": [
    "Count the purposes listed in the Preamble text — how many are there in total?",
    "Signal A leans on 'establish justice.' Check the other three clauses — do they talk about lawmaking at all?",
  ],
  "SS.5.15A-SC": [
    "Compare Article I and Article II — which branch does each one actually give lawmaking power to?",
    "Signal B is about the veto. Check the veto record — did the president rewrite the bill, or just send it back?",
  ],
  "3.10A-SC": [
  ...
  "4.9B-SC": [
    "Compare the ruler check on the full moon photo to the ruler check on the thin sliver photo — do the widths match?",
    "Signal C says the moon shrinks and grows itself back. Check the feature match readings — do the same craters show up night after night?",
  ],
  "4.10A-SC": [
    "Compare how much water the covered cup lost to how much the uncovered cup lost.",
    "Signal C says the water is completely gone. Check the lid test — what showed up on the underside of the lid?",
  ],
  "4.11A-SC": [
    "Look at the power log for the calm days — how much electricity did the turbine make those days?",
    "Signal C says there's no downside at all. Check the science note about what renewable actually means — is it the same as always available?",
  ],
  "4.11B-SC": [
    "Check how many batteries just one classroom collected in a single year.",
    "Signal C says one battery makes no difference. Compare the landfill note and the recycling note — is what happens to the material really the same either way?",
  ],
  "4.11C-SC": [
    "Compare how much water the sandstone soaked up to how much the granite soaked up.",
    "Signal C says nothing could be stored inside rock. Check the close-up readings — what did the sandstone's close-up show that the granite's didn't?",
  ],
  "4.12A-SC": [
    "Compare the soil's weight before planting to its weight after eight weeks.",
    "Signal C says the plant is eating the soil. Check the no-sunlight plant — if soil were the key ingredient, why didn't it grow just as well?",
  ],
  "4.12B-SC": [
    "Compare how the plants grew in the decomposed soil versus the plain soil.",
    "Signal C says decomposers aren't part of the food web. Check the science note about producers — where do they get the nutrients they need?",
  ],
  "4.12C-SC": [
    "Check whether the shell is embedded inside the rock or just sitting loose on top of the dirt.",
    "Signal C says someone dropped the shell there. Check the other matching fossils found nearby — how many spots on the hill turned up the same kind of shell?",
  ],
  "4.13A-SC": [
    "Compare how much water weight the waxy-leaved plant lost to how much the wax-removed plant lost.",
    "Signal C says the waxy coating doesn't help. Check the deep root test — what could that plant still reach after the topsoil dried out?",
  ],
  "4.13B-SC": [
    "Check what the puppies' ears actually looked like when they were born.",
    "Signal C says the puppies will get the ear notch. Compare the fur color and ear shape checks — which traits DID pass from mother to puppies?",
  ],
  "5.6A-SC": [
    "Compare what happened when the magnet was tried on the steel objects versus the aluminum can and copper penny.",
    "Signal C says a magnet should pick up any metal. Check the science note about magnetism — which metals does it say actually have that property?",
  ],
  "5.6B-SC": [
    "Check what happened when a magnet was pulled through the mixed pile of sand and iron filings.",
    "Signal C says they became one new substance. Compare the recovered filings and sand to what they looked like before mixing.",
  ],
  "5.6C-SC": [
    "Compare the starting total weight to the weight after the salt fully dissolved.",
    "Signal C says some matter is gone. Check the science note about dissolving — where do the salt's particles actually go?",
  ],
  "5.6D-SC": [
    "Compare the balloon's weight deflated to its weight fully inflated.",
    "Signal C says the uninflated balloon has nothing inside it. Check the push-back test — what's pushing back when the inflated balloon is squeezed?",
  ],
  "5.7A-SC": [
    "Compare the force meter readings on the left end of the rope and the right end.",
    "Signal C says the rope has to move. Check what happened to the rope's center mark after 30 seconds of both teams pulling.",
  ],
  "5.8A-SC": [
    "Compare the fresh battery's energy reading to the used battery's reading.",
    "Signal C says the flashlight makes energy from nothing. Check what happened to the bulb's temperature the longer it stayed lit.",
  ],
  "5.8B-SC": [
    "Compare what the motor did with the switch OFF to what it did with the switch ON.",
    "Signal C says the switch doesn't matter. Check the wire check reading — were the wires connected even when the motor wasn't spinning?",
  ],
  "5.8C-SC": [
    "Check what the straw looked like once it was pulled back out of the water.",
    "Signal C says the straw actually bent. Check the viewing angle reading — did the 'bend' stay in the same spot from every angle?",
  ],
  "5.9-SC": [
    "Compare the shadow's direction at 9 AM to its direction at 3 PM.",
    "Signal C says the shadow moves randomly. Check the day-2 repeat reading — did the exact same pattern happen again?",
  ],
  "5.10A-SC": [
    "Compare the ocean-air temperature difference on the foggy mornings to the one clear morning.",
    "Signal C says the fog shows up for no reason. Check the science note about condensation — what has to happen for fog to form?",
  ],
  "5.10B-SC": [
    "Check what the squished mud jar looked like the day after squishing.",
    "Signal C says mud can turn into rock in a day. Check the rock sample reading — how many layers did it have, and how long did scientists estimate they took?",
  ],
  "5.10C-SC": [
    "Compare what happened to the clay tray with repeated water flow versus a single hard shake.",
    "Signal C says the canyon formed overnight. Check the rock layer reading — what do the matching bands on both sides suggest about how it formed?",
  ],
  "5.11-SC": [
    "Check how many gallons one 2-minute brushing session actually used.",
    "Signal C says the savings don't count for anything. Check the yearly total calculation — how much does that same small amount add up to over a year?",
  ],
  "5.12A-SC": [
    "Check what happened to the fish when the tank heater failed, even with the same fish and plants still there.",
    "Signal C says nonliving factors don't matter much. Compare the biotic and abiotic science notes — which category does temperature and light fall into?",
  ],
  "5.12B-SC": [
    "Check what happened to the ground beetle population after the bird feeder went up.",
    "Signal C says feeding the birds only affects the birds. Check the wildflower reading — what species felt the effect that never touches the feeder at all?",
  ],
  "5.12C-SC": [
    "Compare where the rainwater went before and after a similar nearby lot was paved.",
    "Signal C says paving won't affect anything else. Check the rain garden reading — what moved back in after it was built?",
  ],
  "5.13A-SC": [
    "Compare how the turtles and the fish each get through winter in the same pond.",
    "Signal C says every pond animal survives the same way. Check the frog reading — is freezing solid anything like what the turtles or fish do?",
  ],

  // ---------- Mission Map ----------
  // Indexed by checkpoint position (hint[0] = checkpoint 1, etc.), not a
  // running counter across the whole mission — fixed Aug 30 v4 alongside
  // the checkpoint-interaction rebuild, so a hint actually matches whatever
  // checkpoint the student is stuck on instead of whichever hint comes next
  // in a flat list. Expanded from 2 generic hints (written for v1's
  // 4-checkpoint case) to 6, one per checkpoint, matching v2/v4's real
  // content including the rewritten conflicting-report gate 3 and the new
  // predict-first gate 6.
  // Rewritten Aug 31 (v6) to match 3-1-MM.public.js's real-TEKS retheme
  // (dropped pollen/flower-anatomy content, re-anchored to TEKS 3.12B Food
  // Chains & Ecosystem Changes) — see that file's header comment for why.
  "3.1-MM": [
    "Look at the order again — energy starts at the Sun, not at the bee. What comes right after the Sun?",
    "Which animal in the footage is actually eating something from a flower? Watch out for the ones that are just resting or doing something unrelated.",
    "Which volunteer's note actually matches what you already know about bee visits and seeds? One of these notes doesn't line up with the evidence.",
    "Think about what the sparrow eats. If there are fewer seeds, what happens to the sparrow's food?",
    "Which idea actually gives bees food all season long — not just something bright or big?",
    "Look at both cages side by side — one let bees in, one didn't. Which cage's result actually answers whether bees matter here?",
  ],

  // ---------- Grade 4 Science ----------
  // First Grade 4 Mission Map case (Aug 31), Earth & Space (TEKS 4.9B — Moon
  // Patterns) — see 4-1-MM.public.js for the scope/TEKS notes.
  "4.1-MM": [
    "Look at the shape across nights 1, 4, and 7 — is the lit part getting bigger, smaller, or staying the same?",
    "Look at what happens right after the full moon on night 11 — does the pattern keep growing, or does it turn around?",
    "Which camper's report matches what's already been happening since night 18 — growing back toward full, or shrinking further?",
    "The nights right before the smudge (night 7) and right after (night 11) can help you figure out what's in between — what should be happening at night 8, 9, and 10?",
    "Count from the first thin sliver all the way to the next matching thin sliver — about how many nights does that take?",
    "Night 29 looked almost exactly like night 1 — what does that tell you is about to happen again?",
  ],

  // ---------- Grade 5 Science ----------
  // First Grade 5 Mission Map case (Aug 31), Force/Energy (TEKS 5.7A/5.7B —
  // Equal & Unequal Forces / Force Investigation) — see 5-1-MM.public.js.
  "5.1-MM": [
    "Look closely at the two cars' wheels — what's different about how easily each one spins?",
    "Compare the three ramp heights and the three distances — as one number goes up, what happens to the other?",
    "The judge actually measured both ramps — does that measurement support \"the ramp is rigged,\" or does it rule that out?",
    "Think about what a push at the starting line adds that wasn't there before — is that an equal force or an unequal one?",
    "Look at all three balloon trials together, not just the biggest one — what happens to distance as the air amount goes up each time?",
    "A fair test only changes ONE thing at a time — which of the four options only changes the wheels and nothing else?",
  ],

  // ---------- Sept 2, 2026 — first Science batch beyond the original 3
  // cases, completing every remaining Science concept in the 48-concept
  // library. See each case's own .public.js header comment for its TEKS
  // alignment and any re-anchoring notes. ----------
  "3.2-MM": [
    "Look at the two thermometer numbers again — do 61°F and 54°F match, or are they different?",
    "Compare how each wind sock was moving — is \"barely moving\" the same thing as \"gusting and spinning\"?",
    "One of these is a real measurement from a tool at Ridge Camp itself. The other is a guess based on what's happening somewhere else. Which one actually measured the rain?",
    "Look at all three of Ridge Camp's own readings together — cooler, gustier, and rain measured — what do they add up to?",
    "The log already showed three different readings at the same time, at two nearby spots. Does \"close together\" mean \"has to match\"?",
    "A real weather update names the actual tools that were used — which choice does that?",
  ],
  "3.3-MM": [
    "Which of these four objects are actually metal? Only those are worth testing with a magnet.",
    "The paper clip just got tested — what did the quick test show?",
    "The nail and the foil are both metal — but did they both react the same way to the magnet?",
    "Between paper clips and packing peanuts, which one would a magnet actually pull toward it?",
    "Think back to the nail-and-foil test — steel behaves like the nail, aluminum behaves like the foil.",
    "Look back at every test in the maze — did every metal object stick, or just some of them?",
  ],
  "3.4-MM": [
    "The ranger notes only track one kind of animal all year — which one?",
    "During the drought, did the frog count go up or down compared to normal?",
    "After the pond refilled, did the frog count move back toward normal, or keep dropping?",
    "The desert photo shows a different species in a totally different place — does that actually tell you anything about this pond?",
    "The drought already showed what happens when the pond gets less water — what would diverting the stream do?",
    "Think about both events this year — did the frogs react the same way every time, or did it depend on which change happened?",
  ],
  "4.2-MM": [
    "What actually gave the puddle's water the energy to disappear?",
    "The rising vapor got colder higher up — what does cooling water vapor turn into?",
    "Where did the water in the clouds actually come from — was it brand new, or the same water from before?",
    "Look at the stage right before clouds form (condensation) and right after rain falls (precipitation) — what comes in between them?",
    "Once the rain lands and collects, is that water finished moving forever, or ready to start the cycle again?",
    "What keeps giving the water cycle fresh energy, day after day?",
  ],
  "4.3-MM": [
    "What does water freezing and expanding inside a rock's crack actually do to that rock?",
    "Sediment moving away in flowing water — is that the rock breaking down where it sits, or being carried somewhere else?",
    "The water slowed down right where the sandbar formed — what does slower water do with the sediment it's carrying?",
    "One of these two clues was actually measured over time. The other one is just about paint. Which one tells you about the land itself?",
    "Fast water cuts into the outside of a bend; slow water drops material on the inside — which process goes with which speed?",
    "A storm's waves are stronger, not different — does that change WHAT happens, or just HOW FAST it happens?",
  ],
  "4.4-MM": [
    "Which of these three actually makes its own food using sunlight?",
    "Who eats the grass, and who eats that animal next?",
    "What do mushrooms actually do to a dead plant?",
    "Think about which direction food really moves — from what gets eaten, toward what eats it.",
    "If the hawk's main food source drops, what's likely to happen to the hawk?",
    "Trace the whole path again, starting from the Sun — where does the energy end up going?",
  ],
  "4.5-MM": [
    "How long does one afternoon last compared to thirty years?",
    "Which of these two describes tomorrow specifically, and which one describes a long-term pattern?",
    "One of these two clues covers thirty years. The other covers a single afternoon. Which one actually tells you about climate?",
    "A forecast for next week and a chart covering twenty years — which one is the short-term one?",
    "Does one hot day undo what thirty years of average data already showed?",
    "A corrected headline should match what the data actually proved — not what one afternoon felt like.",
  ],
  "5.2-MM": [
    "A brand-new battery was tested and the bulb still didn't light — does that clear the battery, or convict it?",
    "One of these two claims about the bulb is an actual test result from a different circuit. The other is just an assumption. Which one is the real test?",
    "Both the battery and the bulb already passed their tests — so where else in the path could the break be?",
    "What does a complete circuit need in order for energy to travel all the way around it?",
    "Once the bulb is glowing and slightly warm, what two kinds of energy is the electrical energy turning into?",
    "A dead battery and a loose wire are two different problems — do they need the same fix?",
  ],
  "5.3-MM": [
    "Did the sample sink or float? What does that tell you about its density compared to water?",
    "Did the magnet pull the sample toward it, or not?",
    "Did the sample heat up fast, like metal usually does, or stay cool much longer?",
    "The sample failed both the magnet test and the heat test — does looking shiny outweigh both of those results?",
    "A pot handle needs to stay cool near heat — does this sample's heat-conductivity result match that need?",
    "Which should decide what a material actually is — how it looks, or what the tests showed?",
  ],
  "5.4-MM": [
    "Which of the three — grass, rabbits, or hawks — is the one that makes its own food?",
    "Less grass means less food for which animal?",
    "If rabbits are the hawk's main food source, what happens to hawks when rabbit numbers drop?",
    "Which change happened first — the grass, the rabbits, the hawks, or the decomposers?",
    "Which piece of evidence actually shows the ripple reaching all the way to the soil?",
    "Has any change in this food web stayed isolated to just one level so far?",
  ],

  // ---------- Sept 2, 2026 — Social Studies batch, completing every
  // Social Studies concept in the 48-concept library. See each case's own
  // .public.js header comment for its TEKS alignment and any TEKS-anchor
  // notes. ----------
  "3.5-MM": [
    "A city street's traffic light is broken — which level of government owns and fixes city streets?",
    "One crew only handles streets INSIDE town limits. The other only handles the highway OUTSIDE town. Which street is the pothole actually on?",
    "National parks are cared for so people from every state can visit — what level of government does that sound like?",
    "The complaint was about a broken swing, not a new dog park — which one was actually reported?",
    "Driver's licenses come from a state office, not a city office or a national one — which level is that?",
    "Every stop on this route needed a different level of government — does asking the wrong one actually solve anything?",
  ],
  "3.6-MM": [
    "That box of symbols in the corner explains what each picture on the map means — what is it called?",
    "Look back at the map key from Stop 1 — which symbol matched \"School\"?",
    "North is at the top of the compass rose — if the park is BELOW the school, what direction is that?",
    "You've already used the title, the key, and the compass rose in this quest — which one would you actually check first?",
    "Is the statue in the map key at all? Is it on the straight path between the school and the park?",
    "Using the compass rose, is the park North or South of the school — and which direction after that?",
  ],
  "3.7-MM": [
    "A dirt road and a horse-drawn wagon — does that sound like the past or the present?",
    "A paved road with cars and traffic lights — does that sound like the past or the present?",
    "One photo shows travel in the past, the other shows travel today — which one shows how people travel NOW?",
    "The church looks the same in both photos, but did the road and the buildings around it also stay the same?",
    "An empty lot becoming a library — is that an example of a community staying exactly the same, or changing?",
    "This street changed in some ways and stayed the same in others — can both of those be true at once?",
  ],
  "3.8-MM": [
    "A long line and only one pitcher left — is that high or low demand, and high or low supply?",
    "Ten full baskets and almost no customers — is that high or low demand, and high or low supply?",
    "The gold paint is the most requested color and it's almost gone — what does high demand plus low supply usually do to price?",
    "The shopper blamed \"meanness,\" but what did the evidence actually show about the line and the pitcher?",
    "A second lemonade stand means there's now MORE lemonade at the market overall — what does more supply usually do to price?",
    "Every price at this market changed because of two things working together — what are they called?",
  ],
  "4.6-MM": [
    "Flat, wide-open land with hardly any trees — what kind of landform is that?",
    "Very little rain and hot, dry summers — does that match farmland that needs heavy rain, or land used for grazing?",
    "Wide cattle ranches need a lot of flat, dry land — does that match the landform and climate clues you already found?",
    "The explorer only looked at the ranching photo — did they also check the landform and climate clues?",
    "Which Texas region is known for flat, dry land good for large-scale ranching?",
    "Every stop on this trail connected geography to the KIND of work people do there — is that a coincidence?",
  ],
  "4.7-MM": [
    "Which event started this whole chain — the one nothing else on the list caused?",
    "Easier travel and shipping showed up right after the railroad arrived — what did that make possible for the town?",
    "More people in town means more customers — what would business owners want to do about that?",
    "You've already traced the railroad, easier travel, population growth, and new businesses — which one came first?",
    "The drought happened in a different county, in the same year — does \"same year\" prove a connection?",
    "One event — the railroad — led to several DIFFERENT effects. Does a cause always stop at just one effect?",
  ],
  "4.8-MM": [
    "A firsthand, handwritten account from someone who was actually there — is that a primary or secondary source?",
    "A modern chapter written LATER, using other people's diaries and letters — is that primary or secondary?",
    "One claim says the diary shows what this ONE settler felt. The other says it proves what EVERY settler felt. Which one can the diary actually prove?",
    "A photograph only shows what the camera captured in ONE moment — does that mean it shows the whole story?",
    "The map shows a PLANNED route — does that prove settlers definitely followed it?",
    "Every source in this lockbox could prove something — but could any one of them prove everything?",
  ],
  "4.9-MM": [
    "What's the one actual problem the city council needs to decide on?",
    "The business owner mentioned parking — whose need does that represent?",
    "The family mentioned a playground — whose need does that represent, and is it the same need as the business owner's?",
    "The planner only read ONE comment before deciding — did they check every stakeholder's need?",
    "The parking lot costs less, but does cost being lower automatically make it the better choice for everyone?",
    "A fair vote considered more than one need before deciding — does that sound like only one side, or more than one?",
  ],
  "5.5-MM": [
    "A city official is a government employee — does that count as government action?",
    "Blocking a peaceful petition and gathering — which right from the Bill of Rights covers that?",
    "A sibling taking the remote isn't a government official — does this case even reach the first question of the test?",
    "The student never named a SPECIFIC right — does \"unfair\" by itself pass the test?",
    "Being denied a lawyer during a criminal case — which specific right covers that?",
    "Every real case in this file needed BOTH a government action AND a specific right — did the remote-control dispute have either one?",
  ],
  "5.6-MM": [
    "The President signing a law — which branch does that action belong to?",
    "A law that might conflict with the Constitution — is that a normal problem, or exactly the kind checks and balances catch?",
    "One branch reviews whether laws are constitutional. The other branch just votes again. Which power actually belongs to the courts?",
    "A court striking down a law that two other branches already approved — did the judicial branch just gain unlimited power, or check the other branches?",
    "The student said signing laws should mean total control — but can the executive branch also be checked by the others?",
    "Every gear in this machine turned when ONE branch was checked by a DIFFERENT branch — why would a system be built that way?",
  ],
  "5.7-MM": [
    "A river nearby means drinking water, farming water, and boat travel — which geographic factor is that?",
    "A trail connecting this site to other towns — which geographic factor is that?",
    "Fertile soil and nearby forests — which geographic factor is that?",
    "The view is beautiful, but does it provide water, resources, or a trade route?",
    "Which site actually has the river, the trail, AND the fertile soil together?",
    "Which matters more for a settlement's survival — how it looks, or what it can actually provide?",
  ],
  "5.8-MM": [
    "A shop owner talking about ruined stock — what would a shop owner naturally focus on?",
    "A farmer talking about better crops from the same flood — what would a farmer naturally focus on?",
    "Ruined stock matches one person's view; new fertile soil matches the other's — can you match each clue to its speaker?",
    "Two true accounts can still look very different — does disagreeing automatically mean one of them is lying?",
    "The historian's account came later and covered BOTH views — is that the same as picking just one side?",
    "Both people told the truth about their OWN experience — what made those experiences so different?",
  ],
  // ---------- Sept 23, 2026 — Mission Map MATH batch (3.9-5.12-MM) ----------
  // Added after the batch shipped without case hints. One per checkpoint, in
  // checkpoint order; each points at where to look, never at the answer.
  "3.9-MM": [
    "Read the plan again. How many sides does a rectangle have? How many have numbers?",
    "Look at the side across from the smudged one. What do you know about sides across from each other in a rectangle?",
    "Count how many sides each cadet added. How many sides does the fence need?",
    "Picture the fence going around. Where would it stop if it were only 65 feet long?",
    "Is perimeter a distance around, or a space you cover up?",
    "Think about how you found 130. What did you do with every side?",
  ],
  "3.10-MM": [
    "Count the rows first. Then count how many bolts are in one row.",
    "Which card uses the rows and the bolts in each row to find the total?",
    "Each row has the same number of bolts. How many times do you add that number?",
    "Look at how the bolts are split in each story. Does every tray get the same amount?",
    "Both stories use the same numbers. What is different about the groups?",
    "Why can you multiply instead of counting one by one? What is true about every row?",
  ],
  "3.11-MM": [
    "Look at the two posts. What space is between them?",
    "Count the spaces, not the marks. Are the spaces all the same width?",
    "The bottom number tells how many equal parts. The top number tells how many to count from 0.",
    "Both lines have 4 parts. Look closely at the size of each space.",
    "What does fourths mean? Do the parts have to match?",
    "Think about where your plank sits. What did you count to get there?",
  ],
  "3.12-MM": [
    "Look at the bottom of the graph. What does the key say about one square?",
    "The bar has 7 squares. Each square is worth more than 1. What do you do with that?",
    "Use the same key again. How many cadets are in 3 squares?",
    "Did each card count squares or cadets? Which one does the cook need?",
    "The subtraction is right. Check the numbers that went into it.",
    "Before you answer a graph question, what should you always read first?",
  ],
  "4.10-MM": [
    "Compare the tops, then compare the bottoms. Do either of them match?",
    "Is 5/8 more or less than 4/8? Is 3/4 more or less than 2/4? Does 1/2 settle it?",
    "On the strip, how many eighths line up with one fourth?",
    "One claim compares the size of the denominators. The other compares equal-size pieces. Which is fair?",
    "What happens to the size of each piece when you cut the same whole into more pieces?",
    "Use your renamed fraction. Which is bigger, 6/8 or 5/8? Point the symbol the right way.",
  ],
  "4.11-MM": [
    "Read the plan. What shape is the bed, and how long is each side?",
    "Edging goes along the outside edge. Is that a distance around or a space inside?",
    "A rectangle has four sides. Did you add all four?",
    "Mulch covers the whole bed. Which form finds the space inside?",
    "The supplier's note says a distance was ordered. What was actually needed?",
    "One order is a length and one is a covering. Which one gets square feet?",
  ],
  "4.12-MM": [
    "How many equal columns is the whole split into? How many are shaded?",
    "The bottom number is how many equal parts. The top number is how many are shaded.",
    "Which place comes right after the decimal point? Tenths or hundredths?",
    "Look at the grids. Which setting shades the same amount as four of ten columns?",
    "Where does the 4 sit in each number? What happens to a digit's value when it moves one place right?",
    "Both numbers had a 4. What decided how much each one was worth?",
  ],
  "4.13-MM": [
    "Read the last sentence of the note. What is it asking you to find?",
    "Look at each number. Does the question ever ask about sharing packs between people?",
    "Look at the strip diagram. Can you take packs away before you know how many there are?",
    "Check the first plan's numbers. Did the crew eat from one crate or six?",
    "Subtraction is part of the answer. Is it the first step or the second?",
    "Your equation needs the total first, then the packs eaten. Which choice keeps that order?",
  ],
  "5.9-MM": [
    "Decimals are easier to compare when they have the same number of places. How could you make that happen?",
    "Both have 4 tenths. Move one place to the right. What does each reading have there?",
    "One cadet ranks by number of digits. The other compares place by place from the left. Which is reliable?",
    "Write each reading to the thousandths first, then compare starting with the tenths.",
    "Does adding a zero to the right of a decimal change its value? What do extra places describe?",
    "Compare 0.450 and 0.405. Which is greater, and which way should the symbol point?",
  ],
  "5.10-MM": [
    "Each cube is one unit on every edge. What kind of unit measures the space a cube fills?",
    "The floor is 5 cubes by 3 cubes. How do you find how many cubes cover it?",
    "How tall is the inside of the crate, in cubes?",
    "One report counts one face. The other counts every layer. Which measures what is inside?",
    "The note says she reported an area. What part of the crate did she leave out?",
    "Think about how you got 60. What did you multiply?",
  ],
  "5.11-MM": [
    "Look at the key. What does the stem stand for, and what does each leaf stand for?",
    "Count the leaves in the eighties row. Does a repeated score count twice?",
    "Every leaf is one cadet. Add up the leaves in all the rows.",
    "Largest group and more than half are different claims. How many cadets make more than half of 13?",
    "Add the other three groups together. Compare that with the eighties.",
    "What should you test a claim against: how the display looks, or the actual counts?",
  ],
  "5.12-MM": [
    "Are both amounts measured with the same cup? What are the two denominators?",
    "Is one fourth the same size as one third? Can you count unlike pieces together?",
    "On the strip, how many twelfths does one fourth cover? How many does one third cover?",
    "One total adds the tops and the bottoms. The other renames first. Does 5/7 make sense?",
    "Compare 5/7 with the 3/4 cup of oats. Can adding flour make the mix smaller?",
    "How many whole twelve-twelfths fit in 17/12? What is left over?",
  ],
  // ---------- Sept 23, 2026 — Mission Map ELAR batch (3.13-5.16-MM) ----------
  // One hint per checkpoint, in checkpoint order. Each points at where to look,
  // never at the answer.
  "3.13-MM": [
    "Whose actions does the story follow the most? That person is the main character.",
    "A trait is what someone is like inside. Which card is not about looks or the weather?",
    "Ask about each key: does it show something Rosa DID? Or did it just happen?",
    "Look for something Rosa chose to do for another person.",
    "This detail is about Rosa. But does it show she is kind? Or does it show something else?",
    "Look at all the keys you collected. Were they about what Rosa said and did?",
  ],
  "3.14-MM": [
    "Read the title again. What is the whole article about?",
    "The main idea is the big point. The other sentences are examples of it.",
    "Which detail shows a home keeping an animal safe?",
    "Both facts are true. Which one is about an animal home?",
    "Check the map rule. Does the cheetah fact help prove the main idea?",
    "A good summary uses the main idea and the gems. Does it add anything extra?",
  ],
  "3.15-MM": [
    "Find the very first thing Jada does in the story.",
    "The problem is what Jada has to fix. What went wrong?",
    "Start with Jada at the park. What has to happen before she needs a plan?",
    "Before this moment, Jada is stuck. After it, she has an idea. Which event is that?",
    "Would the story change if the kite were blue? Would it change if the worker had helped?",
    "Think about cause and effect. What made Jada need the ranger?",
  ],
  "3.16-MM": [
    "Big bold words at the top of a section have a job. What do they tell you first?",
    "Look at the words under the photo. What do they tell you about the yellow balls?",
    "Read the three labels. What do they point to?",
    "Does the feature give you information? Or does it only decorate the page?",
    "The paragraph has steps. Which feature could show steps in order?",
    "Think about every feature you cracked. What did all of them help you do?",
  ],
  "4.14-MM": [
    "What does Theo want? What keeps going wrong when he does it his way?",
    "You want evidence about Theo BEFORE he changes. Which choice shows how he treats help at the start?",
    "A turning point is when a character starts to see things differently. When does Theo stop refusing help?",
    "Could the sentence be a lesson for anyone, or does it only tell what Theo did?",
    "Compare the ending to the beginning. What is Theo doing now that he refused to do before?",
    "A theme is not what happened. It is what the story teaches through how a character changes.",
  ],
  "4.15-MM": [
    "Look for one object that shows up in Part 1, Part 2, AND Part 3.",
    "In Part 1, what does Lena think of the scarf, and where does she put it?",
    "In Part 3, how does the scarf smell and feel to Lena now?",
    "Would an author bring the same object back three times by accident?",
    "The scarf never changed. Lena did. What might the author want readers to understand from that?",
    "Think about what the repeated scarf let you see. Why would an author choose to do that?",
  ],
  "4.16-MM": [
    "The claim is what the writers want to happen. Look at the first sentence after the greeting.",
    "Look at who the letter is addressed to. Who can actually make this decision?",
    "A principal cares about learning and safe behavior. Which fact is about those things?",
    "Both facts are true. Which one would matter to a principal?",
    "Parents care about their kids being healthy and happy. Which fact is about that?",
    "The same claim needed different facts for different readers. Why?",
  ],
  "4.17-MM": [
    "What keeps going wrong for Class 4B? That is the problem the story is about.",
    "Start with what the class did first. What had to happen before they built a fence?",
    "If you left this detail out, would a reader still understand the story?",
    "One sentence tells what happened. The other tells what someone thinks. Which belongs in a summary?",
    "Which event actually solved the problem? Does a short summary need the attempt that did not work?",
    "Check each summary: key events, in order, no small details, no opinions.",
  ],
  "5.13-MM": [
    "Does the story name Marcus's feeling anywhere? If not, what will you have to do to answer?",
    "Which choice describes what Marcus's body is doing, not just where he is?",
    "Compare Marcus's words with how his voice sounds. Do they match?",
    "Think about a time someone you know was waiting for something important. What did they feel?",
    "One inference is possible in real life. The other is supported by the story. Which clues does each one use?",
    "Look back at your board. What did you combine to reach your answer?",
  ],
  "5.14-MM": [
    "Look at both titles. What subject do they share?",
    "Text 1 gives information. What does it want readers to understand about reefs?",
    "Text 2 tells an experience. How does the narrator feel when she sees the reef?",
    "Same topic, but do both texts leave you with the same idea or feeling?",
    "Which text actually mentions warm water?",
    "You compared an article and a story on one topic. What did you learn about how texts can differ?",
  ],
  "5.15-MM": [
    "Is the statement about one event in the story, or about life in general?",
    "Look for the moment when Priya herself says what mattered more to her.",
    "Strong theme evidence shows a lesson, a change, or a realization. Which one does the journal show?",
    "Both sentences are true. Does one of them show Priya's thinking change?",
    "Look at Priya's promise to Ava. What does the dropped baton turn into?",
    "Think about which evidence got you out and which did not. What did the strong evidence have in common?",
  ],
  "5.16-MM": [
    "Read the headline and the first sentence together. What problem is the article about?",
    "Look at the last sentence. What does the author ask readers to go and do?",
    "Which word would feel different if you swapped it for a plainer one?",
    "Why would an author add a number from scientists to an opinion article?",
    "One explanation connects the fact to what the author wants. The other does not. Which is which?",
    "Which sentence mostly gives information, without pushing the reader toward the goal?",
  ],
  // ---------- Sept 21, 2026 — Math (MA.) and ELAR (ELA.) Group Chat, Grade 4 ----------
  "MA.4.2F": [
    "Look at Meter Pete — where did each frog's tape land? If the numbers say one thing and the tape says another, which one got read wrong?",
    "Tenley says 0.5 fills five of her ten strips. How many of Centi's hundred tiny squares would cover that same space?",
  ],
  "MA.4.3E": [
    "Count the markers — how many sections did Priya pass in the morning, and how many after lunch? How many is that out of Wendy's 8?",
    "Priya had already hiked 3/8 by lunch. Is 5/16 more or less than 3/8? Can hiking more leave her with less?",
  ],
  "MA.4.2G": [
    "Look at Volt — how many of his ten bars are lit for Eli's 0.5? How many for Maya's 1/5? Are those the same?",
    "Think about the Dime Squad. How many dimes is half a dollar? How many dimes is one fifth of a dollar?",
  ],
  "MA.4.6B": [
    "Crease folded Paralee down the middle. Did her halves land exactly on top of each other? Try another fold line too — corner to corner.",
    "Rex Tangle and Paralee both have two pairs of parallel sides. So what is different about how their halves match when they fold?",
  ],
  "ELA.4.10A": [
    "Read Leash Line again. Is the last sentence trying to make you laugh, or asking you to do something?",
    "Fax has three real facts in it. Why would a writer who only wanted to be funny include facts about dog exercise?",
  ],
  "ELA.4.8A": [
    "'Goats' tells what the fable is about. What does the fable teach? Try saying it as a sentence that would be true for a person, too.",
    "Look at Old Ram's only line. What changed between Pip's first try and Pip's seventh — the rock, or Pip?",
  ],
  "ELA.4.9E": [
    "Frank Fact is true. But what does it actually show — that a four-day week is possible, or that it would make Oakwood better?",
    "Fiona Fact is about students missing fewer days. How could that connect to a school being 'better'? Did the letter explain that connection?",
  ],
  "ELA.4.11D": [
    "Find every subject and verb pair in Sam's sentence — who did something, and what did they do? How many did you find?",
    "Comma says it can't fix this alone. Who does it need, and how many complete thoughts can they join together at once?",
  ],
  // ---------- Sept 21, 2026 — Math (MA.) and ELAR (ELA.) Group Chat, Grades 3 and 5 ----------
  "MA.3.3H": [
    "Look at what happened when Octavia lay on top of Quinn. Did she cover all of Quinn, or only part?",
    "Both pizzas are the same size. If you cut one into more slices, what happens to the size of each slice?",
  ],
  "MA.3.5C": [
    "Count the Triplets. How many pages are there, and how many stickers does each one hold?",
    "Rosa added 3. Does 'three times as many' mean three more, or three groups?",
  ],
  "MA.3.6C": [
    "Fenwick counts the outside. Patch counts the inside. Which one tells you how much room Biscuit has to run?",
    "Compare Patch's numbers for the old pen and the new pen. Did the inside get bigger or smaller?",
  ],
  "MA.3.5B": [
    "Look at the Row Crew. Are these six tables being joined to four more things, or does each table have its own group of four?",
    "Ms. Lin already sold 20 cupcakes and still has some left. Could there be only 10?",
  ],
  "MA.5.3I": [
    "Cuppy is a half-cup. If she scoops 6 times, how many whole cups is that?",
    "Look at Cardie's pattern: 6 x 2, then 6 x 1, then 6 x 1/2. What happens to the answer each time the number gets smaller?",
  ],
  "MA.5.3E": [
    "Pencil Pack asked a good question. Is $0.450 more money than $0.45, or the same?",
    "Look at Columbo's chart. When you multiply by 10, do the 4 and the 5 stay in the same places?",
  ],
  "MA.5.5": [
    "Go through Recta's rules one at a time. Does Squire break any of them?",
    "Having his own name doesn't stop Squire from meeting other clubs' rules. Check Rhonda's rule too — where should Venna put him?",
  ],
  "MA.5.4F": [
    "Logan says there were four baskets worth 2 points each. What part of 3 + 4 x 2 shows those baskets?",
    "The Paren Twins say they aren't in this expression. Where would they have to stand for Nia's answer to be right?",
  ],
  "ELA.3.6F": [
    "Slam is being dramatic, but what is Slam telling you about how Marco came through the door?",
    "Mom says Marco always tells her about his games. What's different today, and why might that be?",
  ],
  "ELA.3.3C": [
    "Try Dizzy's trick on each word: 'not agree,' 'not like,' 'not play.' Which ones make sense on a flyer about art?",
    "Mr. Park wants people to come and look at the art. What is a display for?",
  ],
  "ELA.3.9D": [
    "Hooky says her only job is to make you keep reading. Is a question the same thing as an idea?",
    "Read paragraphs two and three again. What are both of them about? Does Header agree?",
  ],
  "ELA.3.7C": [
    "Stanza Three wants to be read again. What happened to the brother's kite?",
    "Look at the first stanza and the last one. Does Rosa sound bored at either point?",
  ],
  "ELA.5.10D": [
    "Leaf says the current takes it wherever it goes. What in the poem is doing that to the speaker?",
    "Look at 'I could not stop. I could not turn around.' How do those lines help you understand the river?",
  ],
  "ELA.5.10B": [
    "Headline Hank keeps saying 'why.' Does a sequence text answer 'why' or 'when'?",
    "The Dam calls it a chain. Find the words that link one event to the next — are they time words or cause words?",
  ],
  "ELA.5.8A": [
    "Stage Directions pointed out three moments. How is Lucia different at the end than at the start — in more than one way?",
    "Noah told what happened. What lesson could a reader take into their own life from what happened?",
  ],
  "ELA.5.9E": [
    "Blaze is loud, but is 'everyone LOVES them' a fact you could check, or an opinion?",
    "Cleo is true. But does ancient Egypt tell Mr. Diaz anything about why THIS class should get a pet?",
  ],
  // ---------- Sept 21, 2026 — Math (MA.) and ELAR (ELA.) Signal Check, Grades 3-5 ----------
  "MA.3.8B-SC": [
    "Add up the tacos, salad, and soup bars. Is that more or less than pizza's 14?",
    "How many students voted in all? Is 14 more than half of them?",
  ],
  "MA.3.4D-SC": [
    "Count the plants in row 3 carefully. Does it match rows 1 and 2?",
    "3 × 7 means 3 rows of 7. Is that what the photo really shows?",
  ],
  "MA.3.9C-SC": [
    "Read Jada's note again. Did she plan to buy the snack?",
    "Jada still has money. But look at her savings chart — when will she get the art kit now?",
  ],
  "MA.3.2D-SC": [
    "How many digits does 12,800 have? How many does 9,760 have?",
    "The last number is the biggest. But are the two numbers in the middle in the right order?",
  ],
  "MA.4.9B-SC": [
    "Look at every stack on the dot plot, including the half sizes. Which one is tallest?",
    "Size 7 wins among whole sizes. Does the claim say 'whole sizes,' or all sizes?",
  ],
  "MA.4.4G-SC": [
    "Which estimate lands closer to the exact total of $2,848 — $2,800 or $4,000?",
    "The claim says 'about $3,000,' then says $2,500 is enough. Does the exact total agree?",
  ],
  "MA.4.10B-SC": [
    "The cash box had $40. How much of that had to go back to pay for supplies?",
    "Profit is what's left after costs. What's $40 minus the $16 in supplies?",
  ],
  "MA.4.3C-SC": [
    "Are 6/8 and 3/4 equivalent? Try doubling the top and bottom of 3/4.",
    "Look at how many gallons each tank holds when full. Is 3/4 of one the same as 3/4 of the other?",
  ],
  "MA.5.9C-SC": [
    "Look closely at the 60-second line. Are any dots sitting right on it? Do they count as 'under'?",
    "Most dots slope down. Do all of them? Check the students who practiced 10 days.",
  ],
  "MA.5.10F-SC": [
    "Add every expense line. Is the total more or less than $3,200?",
    "If the Chens stopped eating out, what would their expenses be? Is that at or below their income?",
  ],
  "MA.5.6B-SC": [
    "Find how many cubes fit in each box's bottom layer. Then multiply by the number of layers.",
    "Box B is taller, but its base is smaller. What happens when you multiply it all out?",
  ],
  "MA.5.3K-SC": [
    "Add the three prices yourself, lining up the decimal points. What do you get?",
    "The totals are close. But would you want to pay 10 cents extra on every receipt?",
  ],
  "ELA.3.7C-SC": [
    "Look at how Ellie played. Does anything in the story show she was nervous?",
    "What was happening at 6:00? Why might Ellie need to leave early?",
  ],
  "ELA.3.9D-SC": [
    "Count how many sentences are about honey. What are the rest of the paragraphs about?",
    "Apples, berries, pumpkins — what do those paragraphs have in common?",
  ],
  "ELA.3.6F-SC": [
    "Does the story ever say \"Max is Lily's brother\" in those exact words? What does it give you instead?",
    "Pajamas at the same table, the family car, their Aunt Rosa — what do all those clues point to?",
  ],
  "ELA.3.9E-SC": [
    "Which line could you check by reading the box? That one is a fact.",
    "Could anyone ever prove that ALL kids love a cereal? What kind of statement is that?",
  ],
  "ELA.4.10A-SC": [
    "Find a sentence where the flyer asks you to buy, do, or believe something. Can you find one?",
    "Exclamation points show a feeling. What feeling — and is feeling excited the same as persuading?",
  ],
  "ELA.4.8A-SC": [
    "The claim fits Maya. Does it fit Jonah? He worked just as hard.",
    "Read what Jonah realized at the end. What lesson is the author teaching with his ending?",
  ],
  "ELA.4.13D-SC": [
    "Who wrote the diary, and when? Was she there when the flood happened?",
    "The history book is secondary. But does printing a diary inside a book change who wrote the diary?",
  ],
  "ELA.4.8B-SC": [
    "Compare Coach Leo in June and in August. Is anything different?",
    "Now compare Ana in June and August. Who acts differently by the end?",
  ],
  "ELA.5.9E-SC": [
    "Would someone who doesn't want a skate park use the $250,000 fact? Which side does it help?",
    "Read the author's next sentence after the cost fact. What is the author doing there?",
  ],
  "ELA.5.8B-SC": [
    "If the storm stopped right now, would Tomas and Luis stop arguing? What are they really upset about?",
    "Read what Luis yells. What does it tell you about their friendship?",
  ],
  "ELA.5.13D-SC": [
    "Which writer was actually there that day? Which one tells you where the number came from?",
    "The blog is newer. But what evidence does it give for 'thousands'?",
  ],
  "ELA.5.10C-SC": [
    "Read the graph's title. Is it counting the same thing as the paragraph?",
    "Could a garden have the most tomato plants and still get the most pounds of peppers?",
  ],
};
