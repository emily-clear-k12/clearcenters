...
export const CASE_HINTS = {
  ...
  "3.1-MM": [
    "Look at the flower diagram again — what has to move from the stamen to the pistil for a seed to start? Bright petals alone don't do that job.",
    "Which animal in the footage actually touches the flower's center and carries something away? Watch out for the one that visits but never touches the middle.",
    "Which volunteer's note actually matches what the trail camera already showed you? One of these notes doesn't line up with your own evidence.",
    "The bee visited two different kinds of flowers. Does pollen from one kind of flower always work on a totally different kind?",
    "Which idea actually helps pollinators find food all season long — not just something bright or big?",
    "Look at both cages side by side — one let insects in, one didn't. Which cage's result actually answers whether wind alone is enough?",
  ],
};
