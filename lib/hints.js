...
export const CASE_HINTS = {
  ...
  // ---------- Mission Map ----------
  "3.1-MM": [
    "Look at your Evidence Log — which clue actually shows pollen moving, not just a flower looking nice?",
    "A flower can be colorful AND still need a visit from a bee to make a seed. Which clue proves the seed part actually happened?",
  ],
};
