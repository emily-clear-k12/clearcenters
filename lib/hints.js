...
export const CASE_HINTS = {
  ...
  // ---------- Classification Lab (Sept 11 2026 pilot) ----------
  "3.6B-CL": [
    "Think about the rule again — solids keep their own shape, liquids pour and take the container's shape, gases spread out and fill the whole container. Which part of the rule matches what you see?",
    "For the Flag item, look at the CHUNK first, not the fog. Does the chunk keep a definite shape of its own?",
  ],
