...
// Live student cadence (client-driven): questions are primary; short map payoff between beats.
// LIVE_PAYOFF_SECONDS is a brief ships/meters reaction (~3-5s) - never a long sit-and-watch phase.
export const LIVE_PAYOFF_SECONDS = 4;
export const LIVE_QUESTIONS_PER_BEAT = 3;
