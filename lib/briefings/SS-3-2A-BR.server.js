...
//
// Sept 14, 2026 — the .public.js pack was rebuilt (new intelDrop/fieldBrief
// copy, reworked opsChoice/evidenceDrop framing), but every id here
// (reasonSort items, opsChoice project ids, evidenceDrop scene ids) was
// kept identical on purpose, so this file needed NO changes — the new
// copy was written to match these existing keys, not the other way
// around. If you rename an id on the public side, update it here too.
