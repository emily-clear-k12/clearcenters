...
export const PUBLIC_BRIEFING = {
  ...
  reasonSort: {
    ...
    // Answer keys live in SS-3-2A-BR.server.js
    items: [
      { id: "firefighters", text: "Town hires firefighters / posts fire-safety rules" },
      { id: "speed", text: "Speed limits near a school" },
      { id: "worship_move", text: "Group moves so they can worship their own way" },
      { id: "worship_land", text: "Land set aside for a place of worship for anyone" },
      { id: "farms", text: "Families settle near farms and markets for food/work" },
      { id: "market", text: "Market + road so farmers can sell goods" },
    ],
  },
