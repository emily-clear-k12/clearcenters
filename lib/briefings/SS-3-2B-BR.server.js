...
export const SERVER_BRIEFING = {
  ...
  // Sept 14, 2026 — swapped from Reason Sort to Match Pairs (see the
  // .public.js file's comment). Same shape as reasonSort.answers above:
  // no explanation of WHY here on purpose, this is the answer key.
  matchPairs: {
    answerKey: {
      government: "r_gov",
      education: "r_edu",
      communication: "r_comm",
      transportation: "r_transport",
      recreation: "r_rec",
    },
  },
