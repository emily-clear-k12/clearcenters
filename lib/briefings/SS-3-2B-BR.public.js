...
export const PUBLIC_BRIEFING = {
  ...
  // Sept 14, 2026 — Briefings v2 foundation pass: 30 -> 20 min.
  minutes: 20,
  engine: "briefing",
  relatedChallengeIds: [],
  ...
  // Sept 14, 2026 — mechanic swapped from Reason Sort to Match Pairs: this
  // standard's tested verb is "compare," and pairing "the need" with "how
  // both towns handle it" fits that verb better than a category sort does
  // (see lib/briefings/schema/mechanics.schema.js for the mechanic menu).
  phases: ["intelDrop", "fieldBrief", "matchPairs", "opsChoice", "evidenceDrop", "clearance"],
  ...
  engagement: {
    ...
    hiddenBonus: {
      enabled: true,
      samLine:
        "Off the record: Cloudreach's rec center pool was almost a giant duck pond instead. HQ agents voted for the pool. The ducks relocated to the lake and, reportedly, do not miss the noise.",
    },
  },
  ...
  samLines: {
    ...
    matchPairs: "Match each need to how both towns take care of it.",
  ...
  samTips: {
    ...
    matchPairs: "Tap a need, then tap the way that matches it — try again if it's wrong.",
  ...
  matchPairs: {
    title: "Same Need, Different Way",
    kidPrompt: "Match each need to how Maple Crossing and Cloudreach both take care of it.",
    helpWrong: "Hmm — try another match. Which way fits that need?",
    helpPass: "Nice matching! Same need, two different ways.",
    leftItems: [
      { id: "government", text: "Government", icon: "🏛️" },
      { id: "education", text: "Education", icon: "📚" },
      { id: "communication", text: "Communication", icon: "📣" },
      { id: "transportation", text: "Transportation", icon: "🚌" },
      { id: "recreation", text: "Recreation", icon: "🎡" },
    ],
    // No correct-pairing id here — see SS-3-2B-BR.server.js.
    rightItems: [
      { id: "r_gov", text: "Town meeting on the porch vs. a mayor's office" },
      { id: "r_edu", text: "Walk to a small school vs. ride a bus to a bigger one" },
      { id: "r_comm", text: "Ring a bell for news vs. print a weekly paper" },
      { id: "r_transport", text: "A wagon road vs. a river ferry" },
      { id: "r_rec", text: "Splash at the creek park vs. swim at the rec center" },
    ],
  },
  ...
  clearance: {
    ...
    progressGates: [
      ...
      { id: "sort", label: "Need Match complete" },
