...
export const PUBLIC_BRIEFING = {
  ...
  reasonSort: {
    ...
    bins: [
      ...
      { id: "communication", label: "Communication", emoji: "📣", color: "#FF6F91" },
      { id: "transportation", label: "Transportation", emoji: "🚌", color: "#FFC44D" },
      { id: "recreation", label: "Recreation", emoji: "🎡", color: "#6FCF97" },
    ],
    items: [
      ...
      { id: "town_bell", text: "Maple Crossing rings a bell to share the news" },
      { id: "weekly_paper", text: "Cloudreach prints a weekly paper for every house" },
      { id: "wagon_road", text: "A wagon road to carry people and goods" },
      { id: "river_ferry", text: "A river ferry instead of a long wagon trip" },
      { id: "creek_park", text: "Kids splash at the creek park in Maple Crossing" },
      { id: "rec_center", text: "Kids swim at the rec center pool in Cloudreach" },
    ],
  },
