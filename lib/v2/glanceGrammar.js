 ...
 *
 * Spatial (same-spot): SAM strip top · Check-ins left/stack ·
 * grading right/nav · Morning under SAM · Project right edge of teach row ·
 * primary CTA consistent corner.
 */
...
export const GLANCE = {
  needsYou: {
    ...
    /** warm amber */
    fg: "#A67C3D",
    bg: "rgba(255, 236, 210, 0.88)",
    border: "rgba(212, 168, 98, 0.42)",
    wash: "#FFF3E0",
    icon: "amber-soft",
  },
  ready: {
