...
export function checkpointsFor(act, span) {
  ...
  const beatsBySubject = {
    math: [
      { beat: "Explore models", detail: "Try equivalent pairs with strips or number lines." },
      { beat: "Draft the postcard", detail: "Sketch one clear example + a kid sentence." },
      { beat: "Share & turn in", detail: "Partner check, then drop the postcard in." },
    ],
    elar: [
      { beat: "Read & notice", detail: "Mark why the author wrote it." },
      { beat: "Draft short response", detail: "2–3 sentences with one text clue." },
      { beat: "Share & polish", detail: "Read aloud once, then turn in." },
    ],
    science: [
      { beat: "Observe & note", detail: "Gather what you see / measure." },
      { beat: "Build the poster", detail: "Claim + evidence in kid words." },
      { beat: "Share findings", detail: "Quick gallery walk, then turn in." },
    ],
    social: [
      { beat: "Research the region", detail: "Land, people, or one map fact." },
      { beat: "Draft the postcard", detail: "Picture + one sentence from a visitor." },
      { beat: "Share & send", detail: "Partner swap, then turn in." },
    ],
  };
