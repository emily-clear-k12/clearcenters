...
export const ADD_TYPES = [
  { key: "lesson", label: "ClearLesson", product: "ClearLessons", kind: "teach", minutes: 15, title: "New ClearLesson" },
  { key: "sheet", label: "ClearSheet", product: "ClearSheets", kind: "work", minutes: 12, title: "New ClearSheet" },
  { key: "center", label: "Center", product: "ClearCenters", kind: "work", minutes: 20, title: "New ClearCenters station" },
  { key: "quest", label: "Quest", product: "CrystalQuest", kind: "work", minutes: 15, title: "New CrystalQuest" },
  { key: "showdown", label: "Showdown", product: "ClassCade Showdown", kind: "teach", minutes: 20, title: "New ClassCade Showdown" },
  { key: "check", label: "Check", product: "CrystalChecks", kind: "work", minutes: 25, title: "New CrystalCheck" },
];
