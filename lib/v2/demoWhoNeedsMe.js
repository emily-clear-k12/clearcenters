...
export const DEMO_WHO_NEEDS_ME = [
  ...
  },
  {
    ...
    nextHint: "Same kids as Class story — short Check-in, then a reteach on Today.",
    source: "demo",
    periodId: "A",
  },
];

/** Parked Period B math cast (Kai · Riley) — off pitch path. Not merged into Check-ins. */
export const DEMO_WHO_NEEDS_ME_SECONDARY = [
  // Secondary Reports soft (4.3D) â€” other periods; same cast language.
  {
    ...
    nextHint: "Pair share with matching models; keep an eye on Zoe.",
    source: "demo",
    periodId: "B",
  },
  {
    ...
    nextHint: "Gentle nudge, or pull into the group with Maya.",
    source: "demo",
    periodId: "B",
  },
];
