...
export function usePlanner() {
  ...
  // Hydrate setup + period from localStorage so Week ↔ Day stay in sync.
  useEffect(() => {
  ...
  }, [activities, setupKey, subjectFilter, classFilter, shownSubjects]);
  ...
  const openSuggestions = useMemo(
    ...
    [handled, setupKey, subjectFilter, classFilter, shownSubjects, setup.classes]
  );
