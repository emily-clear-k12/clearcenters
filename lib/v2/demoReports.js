...
export function getReportsStub() {
  ...
  return {
    title: "How the class looks · by standard",
    samLine: "One quiet Grow glance in the same teacher home — soft demo by standard, then Check-ins when someone needs you.",
