...
export const DEMO_ASSIGNMENTS = [
  ...
  },
  {
    ...
    when: "2 days ago",
    softSummary:
      "When the models matched, reasons were solid. When they didn’t, Kai and Riley went quiet or guessed.",
    calmNext:
      "Pair share with matching models first, then Check-ins for Kai · Riley if they’re still stuck.",
    bands: [
      {
        key: "clear",
        label: "Looking clear",
