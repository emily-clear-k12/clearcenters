...
// Demo standards only. Ties soft counts to Check-ins naming.

export const REPORTS_HREF = "/v2/teacher/reports";

/**
 * Demo standards for the Reports stub.
 * classPct = rough “clear / ready” class share (demo).
 * needsCheckIn = kids who may need a Check-in pull (demo count).
 */
...
export function getReportsStub() {
  ...
  return {
    ...
    samLine: "Glance first — class ready % and who may need a Check-in.",
    rows,
    summary: {
