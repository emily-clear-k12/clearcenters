...
export const MAKER_MODES = [
  ...
  },
  {
    ...
    live: true,
    instructions:
      "Use the pen to draw your idea. Erase mistakes or clear and start over. Tap Done when your sketch feels finished.",
  ...
  },
  {
    ...
    live: true,
    instructions:
      "Draw how it works. Add a short caption. You can tap a label chip onto the canvas if you want.",
  ...
  },
  {
    ...
    live: true,
    instructions:
      "Add a title, a short caption, and one picture (draw it or upload). Keep it clear and bold.",
  ...
  },
  {
    ...
    live: true,
    instructions:
      "Tell the idea in 2–4 panels. Draw in each box and add one speech or thought line.",
