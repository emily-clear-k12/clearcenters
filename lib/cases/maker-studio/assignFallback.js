...
export const QUICK_MS_ASSIGN_FALLBACK = {
  ...
  lesson_summary:
    "Students open Maker Studio, read the prompt, finish the assigned make modes, then submit when the finish count is met. Teacher reviews the pieces — not AI-graded. About 10–20 minutes.",
  misconception_note:
    "Wave 1: Write, Sketch kit, Diagram, Poster, Comic, and Voice note are live. Students only see the modes the teacher assigned (from ready-made menus).",
};
