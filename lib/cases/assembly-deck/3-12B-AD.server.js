...
export const SERVER_CASE = {
  ...
  whatIf: {
    key: "a",
    walk: ["plants", "minnows", "herons"],
    walkLine: "Plants make the food. Minnows eat the plants. Herons eat the minnows.",
    why: {
      a: "Yes. The plants make the food. If they die, the minnows lose it, and then the herons do too.",
      b: "The herons would leave. The minnows would leave first, because they eat the plants.",
      c: "The sun does not feed the animals. The plants do.",
      d: "The algae are the plants. If the plants die, they are already gone.",
    },
  },
  look: {
    key: "chain",
    hint: "Follow the arrows. The picture connects the plants, the minnows, and the herons. It does not show a bear, and it does not pick a favorite.",
    why: "Yes. The arrows go from the plants to the minnows to the heron.",
  },
  repair: {
    pieceId: "r2p5",
    model: "The notes never say a bear was at the pond.",
    why: "Yes. That sentence tells the truth. The notes never showed a bear.",
  },
};
