...
export const PUBLIC_CASE = {
  ...
  debrief: {
    pinpoint: {
      prompt: "Tap the one sentence in your report that explains why people in the Coastal Plains live close together.",
      hint: "The answer starts with the land, not with the cities.",
    },
    quickCheck: {
      prompt: "Why is land cheaper in the Mountains and Basins region?",
      choices: [
        { id: "a", text: "So little of it can be farmed." },
        { id: "b", text: "The state sets one low price for all western land." },
        { id: "c", text: "Nobody is allowed to build houses there." },
        { id: "d", text: "It sits closer to the state's biggest cities." },
      ],
    },
  },
  explain: {
    prompt: "The family has one more question: how does the land in a region shape the way people live there? Use both regions in your answer.",
    criteria: [
      "Name one thing about the land in each region.",
      "Say how that land changes the way people there make a living.",
      "Use the word region.",
    ],
  },
  board: null,
