...
export const PUBLIC_CASE = {
  ...
  brief: [
    ...
    "Yours argues for the later time. A real argument has a claim with evidence, an honest answer to the other side, and an ending that asks for something specific.",
  ...
  source: {
    ...
    lines: [
      ...
      "Four families told the coach that an after-school time would create a pickup problem for younger siblings.",
    ],
  },
  rounds: [
    {
      ...
      pieces: [
        ...
        { id: "r1p3", text: "Morning practice attendance averages 68 percent, while after-school practice averaged 91 percent last spring." },
        { id: "r1p4", text: "Players who arrive fed get more out of the same hour, and the 23-point attendance gap shows an after-school time is one far more of them can actually make." },
        { id: "r1p5", text: "On the two things a practice needs — players present and players able to work — the later time wins on our own numbers." },
    ...
    },
    {
      ...
      pieces: [
        ...
        { id: "r2p3", text: "Four families told the coach that an after-school time would create a pickup problem for younger siblings." },
        { id: "r2p4", text: "Both of those are scheduling problems with scheduling answers: a 4:30 start on two days, and a standing carpool for the four families who asked." },
        { id: "r2p5", text: "The objection is real, but it argues for a careful schedule, not for keeping a 7:00 a.m. practice that a third of the team misses." },
    ...
    },
    {
      ...
      pieces: [
        ...
        { id: "r3p3", text: "It also gives the four families who raised pickup concerns a fixed, predictable time to plan around." },
        { id: "r3p4", text: "If attendance climbs toward last spring's 91 percent, the team gains the equivalent of several extra practices a month without adding an hour to anyone's day." },
        { id: "r3p5", text: "One season at the later time would show whether the numbers hold, and the school can move practice back if they do not." },
  ...
  explain: {
    prompt: "Write two or three sentences to the athletic director: why did you leave those six sentences out, and how does leaving them out make the argument stronger?",
    criteria: [
      "Names at least two rejected sentences.",
      "Explains the problem with each — an insult instead of an argument, a claim the data contradicts, or a story used as evidence.",
      "Says why a weak or false sentence costs you a reader who disagrees.",
    ],
  },
  board: null,
};
