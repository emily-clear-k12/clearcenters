...
export const PUBLIC_CASE = {
  ...
  chain: {
    ...
    cutId: "plants",
    sourceId: "sun",
    cutting: "Cutting the plants…",
    cutDone: "Plants cut. Minnows dark. Herons dark.",
    liveLine: "Line is live. Mark who you think goes dark.",
    fillLine: "Power moves along the line as each paragraph locks.",
    breakOn: "r3",
  ...
  whatIf: {
    ...
    switch: "Cut the plants",
    choices: [
      { id: "a", text: "The minnows and the herons", marks: ["minnows", "herons"] },
      { id: "b", text: "Only the herons", marks: ["herons"] },
      { id: "c", text: "Nobody. The sun still feeds them.", nobody: true },
      { id: "d", text: "Only the plants", marks: ["plants"] },
    ],
  },
  look: {
