...
export const PUBLIC_CASE = {
  ...
  assembly: {
    ...
    hint: "A reader needs the start of the chain, then who eats whom, before a broken link makes sense.",
    slots: [
  ...
  chain: {
    title: "Station Pond",
    breakOn: "r3",
    breakLine: "The minnows are gone. The algae spread. The herons left.",
    links: [
  ...
  whatIf: {
    prompt: "The log is right. Now Chief asks something the notes do not say. If the plants died instead of the minnows, who would leave?",
    hint: "Follow the chain you just built.",
    choices: [
      { id: "a", text: "The minnows and the herons" },
      { id: "b", text: "Only the herons" },
      { id: "c", text: "Nobody. The sun would feed them." },
      { id: "d", text: "Only the algae" },
    ],
  },
  repair: {
    roundId: "r2",
    pieceId: "r2p5",
    prompt: "This leftover can be saved. Rewrite it into a true sentence the log could use.",
  },
  board: null,
};
