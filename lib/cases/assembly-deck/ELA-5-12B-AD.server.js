...
export const SERVER_CASE = {
  ...
  "rounds": {
    "r1": {
      ...
      "decoys": {
        "r1p5": "The notes say the opposite. The creek is only where the water ends, and the land that drains into it is the watershed.",
        "r1p6": "A feeling is an opinion, not information. The notes give a definition based on land and water."
      },
      "decoyReason": {
        "r1p5": "contradicts",
        "r1p6": "opinion"
    ...
    "r2": {
      ...
      "decoys": {
        "r2p5": "The notes say rain on the far side of the ridge flows to Pine Creek, not Oak Creek.",
        "r2p6": "The divide splits the rain. Each drop flows down one side to one creek, not into both."
      },
      "decoyReason": {
        "r2p5": "contradicts",
        "r2p6": "contradicts"
    ...
    "r3": {
      ...
      "decoys": {
        ...
        "r3p6": "The notes show a path from the playground to the creek. Nobody has to pour water in for it to arrive."
      },
      "decoyReason": {
        "r3p5": "contradicts",
        "r3p6": "contradicts"
  ...
  "trap": {
    "roundId": "r1",
    "position": 2,
    "text": "Oak Creek is the real watershed, and the land surrounding it does not count at all.",
