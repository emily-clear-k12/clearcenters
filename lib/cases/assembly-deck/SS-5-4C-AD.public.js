...
export const PUBLIC_CASE = {
  ...
  brief: [
    ...
    "Write the new placard in three paragraphs: why they were sent, what they did, and how history should judge it.",
    "Build each paragraph, sort out the sentences the museum will not print, then set the order.",
  ],
  source: {
    title: "MUSEUM RESEARCH CARD",
    lines: [
      "1803: the United States buys the Louisiana Territory from France. The country roughly doubles in size.",
      ...
      "The expedition returned with journals, maps, and hundreds of plant and animal descriptions.",
      "Sacagawea, a Shoshone woman, interpreted and guided for the expedition.",
      "The nations they met had lived on and mapped this land for generations.",
    ],
  },
  rounds: [
    {
      ...
      pieces: [
        { id: "r1p1", text: "The Corps of Discovery went west in 1804 with a list of tasks, not an open invitation to explore." },
        { id: "r1p2", text: "The year before, the United States bought the Louisiana Territory from France. The country roughly doubled in size." },
        { id: "r1p3", text: "Jefferson's written orders were clear: find a water route across the continent, record the plants and animals, and build relations with American Indian nations." },
        { id: "r1p4", text: "The country had just bought land no one in the capital had seen. A government needs to know what is on that land, how to cross it, and who lives there." },
        { id: "r1p5", text: "Those three orders are the measuring stick for everything that followed." },
    ...
    },
    {
      ...
      pieces: [
        ...
        { id: "r2p3", text: "They came back with journals, maps, and descriptions of hundreds of plants and animals new to the United States." },
        { id: "r2p4", text: "They crossed that country with help. Sacagawea, a Shoshone woman, interpreted and guided. The nations they met had lived on and mapped this land for generations." },
        { id: "r2p5", text: "What came home was not a shortcut. It was a record: the first detailed American account of land bought sight unseen." },
    ...
    },
    {
      ...
      pieces: [
        ...
        { id: "r3p3", text: "It succeeded at the other two. It brought back a detailed record and met nations across the territory." },
        { id: "r3p4", text: "A mission can fail its main goal and still matter, if what it learned answered questions no one else could." },
        { id: "r3p5", text: "The expedition is remembered less for the route it missed than for the map it drew of a land where people already lived." },
  ...
  debrief: {
    pinpoint: {
      prompt: "Tap the one sentence in your placard that gives a visitor a standard for judging whether the expedition succeeded.",
      hint: "A standard is something you measure a result against.",
    },
    quickCheck: {
      prompt: "The Corps never found a water route across the continent. Why not?",
      choices: [
        { id: "a", text: "No such route exists." },
        { id: "b", text: "They turned back before reaching the mountains." },
        { id: "c", text: "Jefferson canceled that order partway through." },
        { id: "d", text: "They found it but failed to record where it was." },
      ],
    },
  },
  explain: {
    prompt: "The curator wants one more line for the placard: the expedition failed its first order and is still remembered. Explain how both of those can be true.",
    criteria: [
      "Name the order the expedition failed.",
      "Name what it brought back instead.",
      "Say why that record mattered to a country that had just bought the land.",
    ],
  },
  board: null,
};
