...
export const SERVER_CASE = {
  ...
  "rounds": {
    "r1": {
      ...
      "decoys": {
        "r1p5": "That is the hallway summary. The article says cars will still drive on Maple Street.",
    ...
    "r2": {
      ...
      "decoys": {
        "r2p5": "The notes say one parking lane becomes the bike lane, not both.",
        "r2p6": "A bike lane is not a ban. Cars will still drive there."
      },
      "decoyReason": {
        "r2p5": "unsupported",
        "r2p6": "contradicts"
    ...
    "r3": {
      ...
      "decoys": {
        "r3p5": "Exciting does not make the hallway line true. A summary follows the article.",
        "r3p6": "Skipping the article means you are repeating a rumor, not summarizing."
      },
      "decoyReason": {
        "r3p5": "opinion",
        "r3p6": "offtopic"
  ...
  "trap": {
    "roundId": "r3",
    "position": 2,
    "text": "In short, cars are banned, which is what the article meant by a bike lane.",
  ...
  "modelAnswer": "The city will paint a bike lane on Maple Street in August, from the school to the park. Cars will still drive there. One parking lane will become the bike lane. The article does not ban cars.",
