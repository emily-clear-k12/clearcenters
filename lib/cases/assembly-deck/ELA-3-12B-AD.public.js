...
export const PUBLIC_CASE = {
  ...
  debrief: {
    pinpoint: {
      prompt: "Tap the one sentence in your article that uses a number to show the bins are working.",
      hint: "Look for a sentence that counts something.",
    },
    quickCheck: {
      prompt: "Why does an informational article use a fact like \"40 fewer bags\"?",
      choices: [
        { id: "a", text: "So a reader can check if it is true" },
        { id: "b", text: "So the article sounds longer" },
        { id: "c", text: "So the writer can share a feeling" },
        { id: "d", text: "So the reader will laugh" },
      ],
    },
  },
  explain: {
    prompt: "Ms. Alvarez has one more question. A third grader reads your article and wants to help. What does your article tell them to do, and why does that part come last?",
    criteria: [
      "Name one thing a student can do at lunch.",
      "Say which paragraph tells them to do it.",
      "Say why that part belongs at the end.",
    ],
  },
  board: null,
};
