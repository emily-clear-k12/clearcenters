...
export const SERVER_CASE = {
  ...
  "rounds": {
    "r1": {
      ...
      "decoys": {
        "r1p5": "The notes include a 2019 site that was already out of date for this storm. The internet is not automatically current.",
        "r1p6": "A question about one day needs evidence from that day or a report of it."
      },
      "decoyReason": {
        "r1p5": "unsupported",
        "r1p6": "contradicts"
    ...
    "r2": {
      ...
      "decoys": {
        "r2p5": "That text has no date and no place. The log names the day, the time, and what the water covered.",
        "r2p6": "The notes do not require a scientist. The log is strong because it is firsthand, dated, and specific."
      },
      "decoyReason": {
        "r2p5": "unsupported",
        "r2p6": "opinion"
    ...
    "r3": {
      ...
      "decoys": {
        "r3p5": "Sounding sure is not the same as being about this storm. The site was written in 2019.",
        "r3p6": "The text is primary, but it is not specific. The log is the record that can answer."
      },
      "decoyReason": {
        "r3p5": "opinion",
        "r3p6": "contradicts"
  ...
  "decoyProtest": {
    ...
    "r3p6": "Primary means any primary, including a shrug."
  },
  "requester": {
    "name": "Ms. Alvarez",
    "emoji": "📝",
  ...
  "trap": {
    "roundId": "r3",
    "position": 2,
    "text": "The undated text beats the news story, because a primary source always wins.",
  ...
  "modelAnswer": "The principal's photo log is the best source. It was made on May 4 at 3:10 p.m. and shows water on the blacktop and at the slide. The 2019 website was written before the storm, and the undated text never says where or when.",
