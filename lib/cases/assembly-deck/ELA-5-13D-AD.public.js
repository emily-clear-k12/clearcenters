...
export const PUBLIC_CASE = {
  ...
  "estimatedMinutes": 20,
  "brief": [
    "Did the May 4 storm flood the playground? Four sources are not equally useful.",
  ...
  "rounds": [
    {
      ...
      "pieces": [
        {
          "id": "r1p2",
          "text": "A useful source has to be about that storm."
        },
        {
          "id": "r1p5",
          "text": "Any website is enough, because the internet stays current."
        },
        {
          "id": "r1p1",
          "text": "The question is whether the May 4 storm flooded the playground."
        },
        {
          "id": "r1p6",
          "text": "The question does not need a source at all."
        },
        {
          "id": "r1p3",
          "text": "It should show what someone saw, or quote a person who was there."
        },
        {
          "id": "r1p4",
          "text": "A source from another year cannot answer this question."
        }
      ],
    ...
    },
    {
      ...
      "pieces": [
        {
          "id": "r2p2",
          "text": "It was made on May 4 at 3:10 p.m."
        },
        {
          "id": "r2p5",
          "text": "The text that says today was insane is the best proof."
        },
        {
          "id": "r2p1",
          "text": "The principal's photo log is the strongest source."
        },
        {
          "id": "r2p6",
          "text": "The log is weak because a principal is not a scientist."
        },
        {
          "id": "r2p3",
          "text": "It shows water on the blacktop and at the slide."
        },
        {
          "id": "r2p4",
          "text": "A primary source is stronger when it is dated and specific."
        }
      ],
      "rejectPrompt": "Two sentences are still in the tray. For each one, say what is wrong with it.",
      "reasonOptions": [
    ...
    },
    {
      ...
      "pieces": [
        {
          "id": "r3p2",
          "text": "The 2019 website was written before the storm and names no author."
        },
        {
          "id": "r3p5",
          "text": "The 2019 site is best because it sounds sure."
        },
        {
          "id": "r3p1",
          "text": "Two of the sources should not decide this question."
        },
        {
          "id": "r3p6",
          "text": "Ignore the photo log and use the undated text."
        },
        {
          "id": "r3p3",
          "text": "The undated text names no place and no day."
        },
        {
          "id": "r3p4",
          "text": "The news story can support the log, but the log is the firsthand record."
        }
      ],
