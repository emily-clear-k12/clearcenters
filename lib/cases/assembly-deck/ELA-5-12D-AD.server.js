...
export const SERVER_CASE = {
  ...
  "rounds": {
    "r1": {
      ...
      "decoys": {
        "r1p5": "That is a demand. The notes say the class needs facts before it suggests a change.",
        "r1p6": "A weekend note is not a request to the city engineer."
      },
      "decoyReason": {
        "r1p5": "opinion",
        "r1p6": "offtopic"
    ...
    "r2": {
      ...
      "decoys": {
        "r2p5": "The notes list three questions about one corner, not every street in the city.",
    ...
    "r3": {
      ...
      "decoys": {
        "r3p5": "The notes ask for a reply to the teacher. Deciding the engineer is wrong skips the facts.",
        "r3p6": "A state map does not answer the questions about one corner."
      },
      "decoyReason": {
        "r3p5": "contradicts",
        "r3p6": "offtopic"
  ...
  "decoyProtest": {
    ...
    "r1p6": "Weekends are relevant to weather.",
  ...
  "requester": {
    ...
    "emoji": "📝",
    "replies": {
      "great": "Letter accepted. The engineer could answer you. The corner, the questions, and the reply address are all there.",
      "good": "Letter accepted. The ask is mostly specific. Read the leftovers so an order does not sneak in.",
  ...
  "trap": {
    "roundId": "r1",
    "position": 2,
    "text": "We already know the city is at fault, so questions would only slow the fix.",
  ...
  "modelAnswer": "We are a fifth-grade class. The crosswalk at Oak and 3rd floods after hard rain. Which storm drain serves that corner, when was it last cleared, and is a larger drain already planned? Please reply to Ms. Alvarez.",
  "aiContext": "Grade 5 ELAR, TEKS 5.12D correspondence that requests information. Audience: the city engineer. Problem: the Oak and 3rd crosswalk floods after hard rain. Questions: which drain serves it, when it was last cleared, whether a larger drain is in this year's plan. Reply to Ms. Alvarez. The class needs facts before suggesting a change. Do not accept fix-it-today demands, no questions, do-not-reply, every street, or a state map. Do not penalize spelling.",
  "whatIf": {
    "key": "a",
    "walk": [
      "letter",
