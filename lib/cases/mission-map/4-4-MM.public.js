  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c", text: "No — the arrow shows energy moving FROM the grass INTO the rabbit, since the rabbit eats the grass" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "d", text: "The hawk would likely have less food available, since rabbits are its main energy source here" },
      ],
      correctChoiceId: "d",
