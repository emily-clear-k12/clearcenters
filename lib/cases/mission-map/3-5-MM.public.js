...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The local government of whichever town is closest" },
        { id: "b", text: "Each visitor's home state government" },
        { id: "c", text: "No government is involved in national parks" },
        { id: "d", text: "The national government — national parks are a national government service" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Build the new dog park instead, since it sounds more exciting" },
        { id: "b", text: "Fix the broken swing — that's the actual problem that was reported" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "d", text: "The state government — it issues and renews driver's licenses" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "It doesn't matter — any level of government can fix any problem" },
        { id: "b", text: "Only the national government actually does anything" },
        { id: "c", text: "Each level of government provides different services, so knowing which one to ask saves time and actually solves the problem" },
