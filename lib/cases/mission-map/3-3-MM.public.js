  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "The plastic button, since it's the shiniest one" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "A magnet wand — it'll pull out the paper clips and leave the peanuts behind" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "No — a magnet can't sort any metal cans at all" },
        { id: "b", text: "Yes — a magnet will grab every can, steel or aluminum" },
        { id: "c", text: "Yes — a magnet will pull out the steel cans and leave the aluminum cans behind" },
