  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "Yes — the battery must always be the problem when a bulb doesn't light" },
        { id: "b", text: "It's impossible to test a battery without disassembling the whole circuit" },
        { id: "c", text: "The battery test doesn't tell you anything useful" },
        { id: "d", text: "No — a fresh, correctly-inserted battery still didn't fix it, so the battery isn't the problem" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Replace the battery again" },
        { id: "b", text: "Reconnect the wire firmly to the bulb's base so the path is complete" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The bulb glows without using any energy at all" },
        { id: "b", text: "Electrical energy disappears once the bulb lights up" },
        { id: "c", text: "Electrical energy travels through the complete path and transforms into light energy and thermal energy" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Both circuits need a new battery, since that's always the fix" },
        { id: "b", text: "Both circuits need a new bulb, since that's always the fix" },
        { id: "c", text: "The dead-battery circuit needs a new battery; the loose-wire circuit needs its connection fixed — different problems need different fixes" },
