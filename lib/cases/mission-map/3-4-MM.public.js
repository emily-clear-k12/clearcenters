  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c", text: "The drought made conditions worse for the frogs — many likely moved away or didn't survive" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The flood was just as bad for the frogs as the drought was" },
        { id: "b", text: "The frog count going back up is unrelated to the water returning" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — any frog photo from any drought counts as evidence here" },
        { id: "b", text: "No — a different species in a totally different environment doesn't tell you what happened at Cedar Hollow" },
