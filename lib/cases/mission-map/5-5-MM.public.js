  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "d", text: "No — there's no government action involved, so this isn't a Bill of Rights case, even though it might feel unfair" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c", text: "No — a rule being strict or unfair doesn't automatically mean a specific right was violated; a specific right has to actually be identified" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "The Bill of Rights protects people from government actions that violate specific, named rights — not every unfair situation" },
