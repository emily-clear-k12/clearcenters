...
export const PUBLIC_CASE = {
  ...
  mission: {
    briefText:
      "A stack of case files needs sorting. Only files that pass the Two-Question Test belong in front of a judge. First, is a government actually involved? Second, does a specific Bill of Rights protection apply? Not every complaint that feels unfair passes both questions.",
  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "A private citizen is acting, not the government" },
        { id: "b", text: "A government official is acting — this is government action" },
    ...
    },
    {
      ...
      order: 3,
      position: { x: 42, y: 64 },
      prompt: "Case 3: A sibling takes the remote control without asking. The other sibling calls it \"a violation of my rights.\" Does this pass the Two-Question Test?",
      evidence: {
        type: "passage",
        label: "CASE FILE 2",
      ...
      choices: [
        { id: "a", text: "Yes — any unfair situation is automatically a rights violation" },
        { id: "b", text: "This is a violation of the right to a jury trial" },
        { id: "c", text: "Siblings count as government officials" },
        { id: "d", text: "No. There's no government action, so this isn't a Bill of Rights case, even though it might feel unfair." },
      ],
      correctChoiceId: "d",
      evidenceLogEntry: "No government action is involved, so the remote-control dispute is not a Bill of Rights case. It may be unfair, but it is not unconstitutional.",
    },
    {
      id: "cp4",
      order: 4,
      ...
      evidence: {
        type: "passage",
        text: "\"This rule is so unfair, it has to be against my rights!\" the student says. The student never names which right is affected.",
      },
      choices: [
        { id: "a", text: "Yes — any strict rule is always unconstitutional" },
        { id: "b", text: "Schools can never be involved in rights cases" },
        { id: "c", text: "No. A strict or unfair rule doesn't automatically violate a right. A specific right has to be identified." },
        { id: "d", text: "Unfairness and unconstitutionality always mean the same thing" },
      ],
      correctChoiceId: "c",
      evidenceLogEntry: "A strict or unfair rule is not automatically unconstitutional. A specific right has to be identified and affected.",
    },
    {
      id: "cp5",
      order: 5,
      ...
      choices: [
        { id: "a", text: "The right to freedom of religion" },
        { id: "b", text: "The right to an attorney" },
        { id: "c", text: "The right to bear arms" },
    ...
    },
    {
      ...
      evidence: {
        type: "passage",
        text: "Every real case in this file involved both a government action and a specific, named right. Feeling unfair was never enough.",
      },
      choices: [
        { id: "a", text: "The Bill of Rights protects people from every unfair situation, government or not" },
        { id: "b", text: "Government actions that violate specific, named rights — not every unfair situation" },
      ...
      correctChoiceId: "b",
      evidenceLogEntry: "The Bill of Rights protects against government actions that violate specific, named rights. It does not cover every unfair situation.",
    },
  ],
