  ...
  checkpoints: [
    ...
    },
    {
      ...
      evidence: {
        ...
        text: "\"I checked the marigold the bee visited — there's a small round pod swelling where the flower used to be. The zinnia the bee visited afterward still just has wilted petals, no pod at all. A sunflower no pollinator ever visited still looks exactly like it did on day one.\"",
      },
      secondEvidence: {
        type: "passage",
        label: "FIELD NOTE — VOLUNTEER B",
        text: "\"I checked the zinnia yesterday and I'm pretty sure I saw a tiny pod starting to form on it too — maybe the bee's visit worked after all!\"",
      },
      choices: [
    ...
    },
    {
      ...
      predictBeforeEvidence: {
        question: "Before you see the results — what do you think happened to Cage A, the one with NO insects allowed in (just wind)?",
        options: [
