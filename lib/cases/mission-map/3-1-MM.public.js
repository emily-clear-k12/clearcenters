  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "Plant many more of the exact same flower, all blooming the same single week" },
        { id: "c", text: "Put up bright string lights around the garden at night" },
        { id: "d", text: "Plant a mix of flowers that bloom at different times, so bees always have food nearby" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "Cage A (no bees) had zero seed pods, while Cage B (bees allowed) had several" },
