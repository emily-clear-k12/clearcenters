  ...
  checkpoints: [
    {
      ...
      choices: [
        ...
        { id: "d", text: "A single afternoon — a very short period of time" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Both dashboards describe the exact same thing" },
        { id: "b", text: "The rainy-week forecast is climate; the 20-year chart is weather" },
        { id: "c", text: "Neither dashboard is real data" },
        { id: "d", text: "The rainy-week forecast is weather; the 20-year rainfall chart is climate" },
      ],
      correctChoiceId: "d",
