  ...
  checkpoints: [
    {
      ...
      choices: [
        ...
        { id: "c", text: "It's the map key (legend) — it explains what each symbol on the map means" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "North — anything on a map is North" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "No — the statue isn't in the map key or on the actual route, so it shouldn't be part of the directions" },
