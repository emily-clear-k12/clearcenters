  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "Hawks are the producer, since they're at the top" },
        { id: "b", text: "All three are producers" },
        { id: "c", text: "None of these count as part of a food web" },
        { id: "d", text: "Grass is the producer; rabbits and hawks are consumers" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The rabbit population is completely unaffected by the grass" },
        { id: "b", text: "The rabbit population should be increasing if there's less grass" },
        { id: "c", text: "There's no way to connect grass and rabbit data" },
        { id: "d", text: "The rabbit population is likely dropping because there's less grass for them to eat" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "A photo of a rabbit that has nothing to do with this preserve" },
        { id: "b", text: "The decomposer note — it shows the ripple reaching all the way to matter cycling in the soil, matching the earlier grass-rabbit-hawk pattern" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Adding a new predator would have no effect on anything else in the food web" },
        { id: "b", text: "Only the grass would be affected by a new hawk predator" },
        { id: "c", text: "Food webs stop reacting to change after one ripple" },
        { id: "d", text: "Adding a new predator would likely ripple further, affecting the hawk population and everything connected to it" },
      ],
      correctChoiceId: "d",
