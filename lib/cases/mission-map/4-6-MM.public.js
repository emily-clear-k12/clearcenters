  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "Climate has no connection to what grows or what people do there" },
        { id: "c", text: "A dry climate, which matches grazing land more than farmland needing heavy rain" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Ranching could happen anywhere no matter the landform or climate" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — one photo is always enough to identify a whole region" },
        { id: "b", text: "Ranching photos always mean the exact same region every time" },
        { id: "c", text: "No — identifying a region needs landform, climate, AND economic activity evidence together, not just one clue" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c", text: "The North Central Plains or Great Plains — flat, dry land suited to large-scale ranching" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "People settle randomly with no connection to the land" },
        { id: "c", text: "Only climate matters; landforms have no effect on settlement" },
        { id: "d", text: "Geography (landforms, climate, and resources) shapes what work is possible and where people choose to settle" },
      ],
      correctChoiceId: "d",
