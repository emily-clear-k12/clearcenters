...
export const PUBLIC_CASE = {
  ...
  mission: {
    briefText:
      "Two portal windows show the very same event: a flood that hit a small river town. But a shop owner and a farmer describe it very differently. The portal opens only once you can explain why two honest accounts of the same event can look so different.",
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "A shop owner, focused on store damage" },
        { id: "b", text: "A farmer, naturally focused on how the flood affected their fields and crops" },
        { id: "c", text: "This account has no connection to any specific role" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Both accounts describe the exact same effect on their livelihoods" },
        { id: "b", text: "The evidence doesn't connect to either person's account" },
        { id: "c", text: "Ruined stock matches the shop owner's negative view; new fertile soil matches the farmer's positive view" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — two different accounts always means one person is lying" },
        { id: "b", text: "No — different roles can genuinely experience the same event differently; disagreement doesn't mean someone is lying" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The only truthful account, since it came later" },
        { id: "b", text: "This account proves both original accounts were wrong" },
        { id: "c", text: "A later, broader perspective that considers both points of view instead of just one" },
    ...
    },
    {
      ...
      evidence: {
        type: "passage",
        text: "The shop owner and the farmer both told the truth about their own experience. Their different roles gave them very different experiences of the same flood.",
      },
      choices: [
