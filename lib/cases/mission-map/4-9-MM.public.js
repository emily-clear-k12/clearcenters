  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "This comment represents no real stakeholder need" },
        { id: "c", text: "The need to close all downtown businesses" },
        { id: "d", text: "The need for more downtown parking, from a business owner's point of view" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — the first comment received should always win" },
        { id: "b", text: "No — a fair decision needs to weigh more than one stakeholder's needs, not just the first one heard" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — the cheapest option should always automatically win" },
        { id: "b", text: "No — cost is one important factor, but it should be weighed along with the community's needs, not decided by cost alone" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "A vote is fair no matter how few viewpoints were considered" },
        { id: "c", text: "Democratic decisions never involve trade-offs" },
        { id: "d", text: "Considering more than one stakeholder's needs and trade-offs before voting, rather than listening to only one side" },
      ],
      correctChoiceId: "d",
