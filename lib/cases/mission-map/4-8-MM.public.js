  ...
  checkpoints: [
    {
      ...
      choices: [
        ...
        { id: "b", text: "A primary source — it was created firsthand by someone who experienced the event" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "d", text: "A secondary source — it was created later by someone summarizing other sources, not from firsthand experience" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Photographs always show the complete story of an entire event" },
        { id: "b", text: "It was likely created by someone present, and it can only show what the camera actually captured — not what happened before or after" },
