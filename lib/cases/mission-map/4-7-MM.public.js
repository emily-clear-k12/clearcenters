...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The population would have doubled with or without the railroad" },
        { id: "b", text: "Population growth caused the railroad to be built" },
        { id: "c", text: "These two events have no connection at all" },
        { id: "d", text: "The railroad made travel and shipping easier, causing the town to grow as an effect" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "A second effect — the growing population (itself an effect of the railroad) caused new businesses to open" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "c", text: "Time order alone always proves a cause-and-effect connection" },
        { id: "d", text: "No — happening in the same year isn't enough; there's no evidence connecting the drought to this town's railroad or growth" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "A historical event can only ever cause exactly one effect" },
        { id: "b", text: "Effects always happen before their cause" },
        { id: "c", text: "One cause (the railroad) can lead to a whole chain of connected effects, not just one" },
