...
export const PUBLIC_CASE = {
  ...
  mission: {
    briefText:
      "The counselors at Camp Nightwatch keep a moon calendar. It tells campers how much moonlight there will be for night hikes. A rainstorm smudged three nights in the middle of the calendar! Walk the trail and study the moon data at each stop. Use the pattern to fill in the missing nights. Then predict what the Moon will look like after the calendar ends.",
    goal: "Find the pattern in how the Moon's shape changes over about a month. Use it to predict a missing or future night.",
  },
  ...
  checkpoints: [
    {
      ...
      evidence: {
        ...
        // Real moon-phase strip image, added Aug 31 (v9).
        image: "/mission-map/evidence/4-1-mm-cp1.png",
      ...
      choices: [
        { id: "a", text: "The lit part of the Moon is getting smaller night after night" },
        { id: "b", text: "The Moon disappears completely every few nights" },
        { id: "c", text: "The lit part of the Moon is getting bigger night after night" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Camper B's note — the Moon should be getting bigger again by night 25" },
        { id: "b", text: "Both notes could be true at the same time" },
        { id: "c", text: "Camper A's note — the lit part keeps shrinking after night 18, so night 25 should be smaller still" },
        { id: "d", text: "Neither note counts as real evidence" },
      ],
      correctChoiceId: "c",
      evidenceLogEntry: "Camper A's report held up. By night 25 the lit part had shrunk to a thin sliver, just as the pattern predicted.",
    },
    {
      id: "cp4",
      order: 4,
      ...
      evidence: {
        ...
        // Real archive-photo reveal image, added Aug 31 (v9).
        image: "/mission-map/evidence/4-1-mm-cp4.png",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "About one week" },
        { id: "b", text: "About a month (around 29-30 days) for the whole pattern to repeat" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Night 31 should look exactly full, like night 11" },
        { id: "b", text: "Night 31 should be impossible to predict" },
        { id: "c", text: "Night 31 should look like a slightly bigger sliver than night 29, since the Moon is starting to grow again" },
  ...
  finalResponsePrompt:
    "Explain the pattern you found in the Moon's shape, and use it to help the camp. Your answer should: (1) describe how the Moon's shape changes over about a month (growing, then shrinking, then repeating), (2) use your evidence to explain what the smudged nights should show, and (3) predict what the Moon will look like two nights after the calendar ends, and explain why.",
