  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "The price is likely to go down, since more people want it" },
        { id: "b", text: "The price is likely to go up — high demand and low supply push the price up" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The price is likely to go up, since there's more to sell" },
        { id: "b", text: "The price is always the same at every stall" },
        { id: "c", text: "The price is likely to go down — low demand and high supply push the price down" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "d", text: "High demand for the gold paint, now in short supply, is pushing its price up" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "d", text: "Supply and demand together — how much people want something and how much of it is available" },
      ],
      correctChoiceId: "d",
