...
export const MISSION_MAP_TEKS = {
  ...
  // Math batch, Sept 22, 2026. Anchors checked against the real Texas
  // Mathematics TEKS PDF before authoring; see each case file's header for
  // why three of them avoid the more obvious code.
  "3.9-MM": "TEKS 3.7B — Perimeter & Missing Side Lengths",
  "3.10-MM": "TEKS 3.4D — Equal Groups & Arrays",
  "3.11-MM": "TEKS 3.7A — Fractions on a Number Line",
  "3.12-MM": "TEKS 3.8B — Problems from Scaled Graphs",
  "4.10-MM": "TEKS 4.3D — Comparing Unlike Fractions",
  "4.11-MM": "TEKS 4.5D — Perimeter & Area Problems",
  "4.12-MM": "TEKS 4.2B — Value of a Digit in Decimals",
  "4.13-MM": "TEKS 4.5A — Multi-Step Problems with a Letter",
  "5.9-MM": "TEKS 5.2B — Comparing & Ordering Decimals",
  "5.10-MM": "TEKS 5.6B — Volume of a Rectangular Prism",
  "5.11-MM": "TEKS 5.9C — Problems from Data Displays",
  "5.12-MM": "TEKS 5.3H — Fractions with Unequal Denominators",

  // ELAR batch, Sept 23, 2026. Anchors checked against the real Texas ELAR
  // TEKS and approved by Emily before authoring. 3.13-MM and 4.15-MM carry
  // the two judgment calls recorded in their case-file headers.
  "3.13-MM": "TEKS 3.7C — Using Text Evidence to Support a Response",
  "3.14-MM": "TEKS 3.6G — Evaluating Details to Find Key Ideas",
  "3.15-MM": "TEKS 3.8C — Plot: Sequence, Conflict & Resolution",
  "3.16-MM": "TEKS 3.10C — Print & Graphic Features",
  "4.14-MM": "TEKS 4.8A — Inferring Themes with Evidence",
  "4.15-MM": "TEKS 4.10A — Author's Purpose & Message",
  "4.16-MM": "TEKS 4.9E — Argument: Claim, Facts & Audience",
  "4.17-MM": "TEKS 4.7D — Summarizing in Logical Order",
  "5.13-MM": "TEKS 5.6F — Making Inferences with Evidence",
  "5.14-MM": "TEKS 5.7B — Comparing Ideas Across Texts",
  "5.15-MM": "TEKS 5.8A — Inferring Multiple Themes",
  "5.16-MM": "TEKS 5.10A — Author's Purpose & Message",
};
