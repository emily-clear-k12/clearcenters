...
export const PUBLIC_CASE = {
  ...
  mission: {
    briefText:
      "This weekend is Derby Day at Westbrook Elementary, where teams race cardboard cars down a ramp. Team Comet keeps winning, and Team Blaze thinks the ramp is rigged. Walk the test track and study the force-and-motion evidence at each stop. Figure out what is really causing the different results, then help design a fair test to check it.",
  ...
  checkpoints: [
    {
      ...
      evidence: {
        ...
        // Real wheel-comparison close-up image, added Aug 31 (v9).
        image: "/mission-map/evidence/5-1-mm-cp1.png",
      ...
      choices: [
        { id: "a", text: "Comet's car is painted a faster color" },
        { id: "b", text: "Comet's team must have pushed the car at the starting line" },
        { id: "c", text: "Comet's smoother wheels meant less force was working against its motion, so it kept moving farther" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Ramp height doesn't change how far the car travels" },
        { id: "b", text: "As ramp height increases, the car travels farther each time" },
    ...
    },
    {
      ...
      evidence: {
        ...
        // Real ramp-measurement diagram image, added Aug 31 (v9).
        image: "/mission-map/evidence/5-1-mm-cp3.png",
      ...
      choices: [
        { id: "a", text: "Team Blaze's note holds up — the ramp really must be uneven" },
        { id: "b", text: "Both notes could be true at the same time" },
        { id: "c", text: "The judge's note holds up — the ramp is measured equal for both cars, so the wheels are the more likely cause" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Car X traveled farther because it's simply a better car" },
        { id: "b", text: "The push made no real difference — 150 cm and 95 cm are basically the same" },
        { id: "c", text: "Car Y should have traveled farther since it started \"clean\"" },
        { id: "d", text: "The extra push was an unequal force that gave Car X more energy of motion, so it traveled farther" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Only Trial 3 counts, since it went the farthest" },
        { id: "b", text: "Only Trial 1 counts, since it's the smallest test" },
        { id: "c", text: "All three trials together — more air (more force pushing out) meant more distance traveled each time" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Race the cars again on the same day, with everything unchanged" },
        { id: "b", text: "Swap the wheels AND add extra weight to Blaze's car at the same time" },
        { id: "c", text: "Let each team pick their own separate ramp to race on" },
        { id: "d", text: "Swap only the wheels between the two cars, and keep the ramp height, angle, and everything else exactly the same" },
      ],
      correctChoiceId: "d",
