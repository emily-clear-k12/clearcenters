...
export const PUBLIC_CASE = {
  ...
  mission: {
    briefText:
      "A settlement map marks three possible sites. Only one holds up once the water, trade route, and resource evidence is fully checked. A scenic mountain view keeps tempting explorers who never check whether that site can actually support people.",
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Trails have no effect on how a settlement grows" },
        { id: "b", text: "Transportation and trade — a connecting trail makes it easier to trade goods and travel to other towns" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Soil and forests have nothing to do with settlement" },
        { id: "b", text: "Resources only matter for decoration, not survival" },
        { id: "c", text: "Natural resources — fertile soil supports farming and nearby forests provide lumber for building" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — scenery should always be the deciding factor" },
        { id: "b", text: "No — a beautiful view doesn't provide water, resources, or trade access, all of which matter more for a settlement's survival" },
    ...
    },
    {
      ...
      evidence: {
        type: "passage",
        text: "The first three survey stops all looked at one river-valley site from different sides. Together they show it has the river, the trade trail, and fertile soil and forest. The mountain-view site has only its view.",
      },
      choices: [
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "A view is always more important than survival needs" },
        { id: "b", text: "Geography has no real effect on where settlements succeed" },
        { id: "c", text: "Water, trade access, and resources are what actually let a settlement survive and grow — a view alone can't do that" },
