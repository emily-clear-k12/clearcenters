  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "Floating tells you nothing about density" },
        { id: "b", text: "The sample has a lower density than water" },
    ...
    },
    {
      ...
      evidence: {
        type: "passage",
        text: "A material that floats, isn't magnetic, and conducts heat poorly would stay cool and light. That makes it useful for something a person must hold safely near heat.",
      },
      choices: [
        { id: "a", text: "A frying pan surface that needs to conduct heat quickly" },
        { id: "b", text: "A compass needle that needs to respond to magnets" },
        { id: "c", text: "A pot handle — something that needs to stay cool to the touch even near heat" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "By guessing based on appearance alone" },
        { id: "b", text: "By whichever property is tested first" },
        { id: "c", text: "By its measured, tested properties — not by how it looks" },
