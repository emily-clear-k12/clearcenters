...
export const PUBLIC_CASE = {
  ...
  mission: {
    briefText:
      "A three-branch government machine has jammed. It will start moving again only once every gear is matched to the branch that can check it. No single branch is allowed to run unchecked. The machine is built so that power stays balanced.",
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "There's no way to challenge a law once it's signed" },
        { id: "b", text: "Only the President can decide if a law is constitutional" },
        { id: "c", text: "A law might be unconstitutional, which is exactly the kind of problem checks and balances exist to catch" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "The judicial branch has now taken over the entire government" },
        { id: "b", text: "This means courts can never be checked by anyone else" },
        { id: "c", text: "Nothing changed about the balance of power" },
        { id: "d", text: "The judicial branch checked the other two branches, keeping any one branch from having unlimited power" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "Yes — the branch that signs laws should control everything" },
        { id: "b", text: "No — every branch, including the executive branch, can be checked by the other branches; no branch has unlimited power" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "So that one branch can eventually control the other two" },
        { id: "b", text: "So that no single branch of government becomes too powerful, and each branch can check the others' actions" },
