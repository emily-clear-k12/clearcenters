  ...
  checkpoints: [
    {
      ...
      choices: [
        { id: "a", text: "One of the thermometers must be broken, since they're only four miles apart" },
        { id: "b", text: "The readings don't count unless they match" },
        { id: "c", text: "It's impossible to compare temperature without seeing both places in person" },
        { id: "d", text: "The two stations are showing different temperatures right now" },
      ],
      correctChoiceId: "d",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "No — Ridge Camp's own readings (cooler, gusty, raining) point to postponing the hike there" },
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "b", text: "No — today's own readings already prove nearby places can have different weather at the same time" },
    ...
    },
    {
      ...
      choices: [
        { id: "a", text: "\"It's probably about the same at both camps since they're close together.\"" },
        { id: "b", text: "\"Whichever camp feels nicer to the counselor writing the update is the accurate one.\"" },
        { id: "c", text: "\"There's no way to know without walking to both stations at once.\"" },
        { id: "d", text: "\"Right now, Lake Camp is warmer and drier than Ridge Camp, which is cooler, gustier, and rainy — based on today's thermometer, wind, and rain gauge readings.\"" },
      ],
      correctChoiceId: "d",
