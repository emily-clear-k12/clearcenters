...
export const PUBLIC_CASE = {
  ...
  tagline: "The salt dissolved into the water and vanished. Some of that matter must be gone now.",
  transmission: {
    claimHeadline: "The salt dissolved into the water and vanished. Some of that matter must be gone now.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The empty cup, the dry salt, and the water were weighed one at a time before mixing to get a starting total.",
      correctVerdict: "True",
      reasonText: "Adding up the separate weights first gives a number to compare the final weight against.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "After the salt dissolved, the full cup of saltwater weighed that exact same total.",
      correctVerdict: "True",
      reasonText: "The totals match before and after. That is direct evidence that nothing was lost when the salt dissolved.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "Matter is conserved when substances mix into a solution. Dissolving just spreads the salt out into particles too small to see.",
    },
  ],

  evidenceReadings: [
    { id: "before_weights", label: "Before weights", reading: "The empty cup, the dry salt, and the water were each weighed by themselves before mixing.", kind: "data" },
    ...
    { id: "after_weight", label: "After weight", reading: "After the salt dissolved, the full cup of saltwater weighed the exact same total.", kind: "data" },
    { id: "taste_test", label: "Taste test", reading: "After mixing, the water tastes salty all the way through, from top to bottom.", kind: "data" },
    { id: "conservation_note", label: "Science note", reading: "When substances mix into a solution, the total amount of matter stays the same. None of it disappears.", kind: "data" },
    { id: "dissolve_definition_note", label: "Science note", reading: "Dissolving spreads the salt out into particles too small to see. It does not remove any matter.", kind: "data" },
