...
export const PUBLIC_CASE = {
  ...
  tagline: "Water never runs out, so it does not matter how much you use.",
  transmission: {
    claimHeadline: "Water never runs out, so it does not matter how much you use.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The town's water tank level dropped during the dry summer.",
      correctVerdict: "True",
    ...
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "The tank always fills right back up, no matter how much is used.",
      correctVerdict: "False",
      reasonText: "The tank only rises after a real rainstorm. It stayed flat during three weeks with no rain.",
      stemEvidenceIds: ["refill_log", "dry_spell"],
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "Water is renewable, so it can never run low in any one place.",
      correctVerdict: "Misleading",
      reasonText: "Water is renewable. But this town's tank still ran low in the dry time. Renewable does not mean there is always enough everywhere.",
  ...
  evidenceReadings: [
    ...
    { id: "refill_log", label: "Refill log", reading: "The tank only rises after a real rainstorm. It does not fill up on its own.", kind: "data" },
    { id: "dry_spell", label: "Dry spell log", reading: "During three weeks with no rain, the tank level did not rise at all.", kind: "data" },
    { id: "renewable_note", label: "Water cycle note", reading: "Water is renewable. It is part of a natural cycle that keeps refilling it over time.", kind: "data" },
    { id: "local_shortage", label: "Local shortage note", reading: "Water is renewable, but this town's tank still ran low in the dry time.", kind: "data" },
