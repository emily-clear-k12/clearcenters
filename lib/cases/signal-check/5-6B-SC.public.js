...
export const PUBLIC_CASE = {
  ...
  tagline: "Once iron filings and sand are mixed, they become one whole new substance. There is no getting the sand back out.",
  transmission: {
    claimHeadline: "Once iron filings and sand are mixed, they become one whole new substance. There is no getting the sand back out.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "A magnet pulled through the mixed pile takes out only the iron filings and leaves the sand behind.",
      correctVerdict: "True",
      reasonText: "If they had become one new substance, a magnet could not separate them so easily.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "The iron filings that were taken out still stick to a magnet, and the leftover sand still looks and feels the same as before mixing.",
      correctVerdict: "True",
      reasonText: "Both materials kept their own properties. That is what happens in a mixture, not in a new substance.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "The iron filings and sand became one new substance that can't be separated.",
      correctVerdict: "False",
      reasonText: "Mixing sand and iron filings makes a mixture. The two materials keep their own properties and can be separated again.",
    },
  ],
  ...
  evidenceReadings: [
    ...
    { id: "recovered_filings_test", label: "Recovered filings test", reading: "The iron filings that were taken out still snap onto a magnet by themselves.", kind: "data" },
    { id: "sand_property_check", label: "Recovered sand check", reading: "The leftover sand still looks, feels, and pours the same as it did before mixing.", kind: "data" },
    ...
    { id: "new_substance_note", label: "Science note", reading: "Only a chemical change makes a truly new substance that can't be separated back into its parts.", kind: "data" },
