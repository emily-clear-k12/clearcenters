...
export const PUBLIC_CASE = {
  ...
  tagline: "The middle bells barely move at all, so the energy must jump right over them to the last bell.",
  transmission: {
    claimHeadline: "The middle bells barely move at all, so the energy must jump right over them to the last bell.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "Take one middle bell out of the row, and the swing never reaches the other end.",
      correctVerdict: "True",
      reasonText: "The gap test shows that with a bell missing, swinging the first bell moved nothing on the far side.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "With all the bells touching, only the last bell swings out. The middle bells barely move.",
      correctVerdict: "True",
      reasonText: "The full row test and the close-up photos both show the middle bells move just a tiny bit.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "The energy is not skipping anything. It passes from bell to bell, through each one in the row.",
    },
  ],
  ...
  evidenceReadings: [
    ...
    { id: "science_definition", label: "Science note", reading: "The energy moves through every bell in the row. It does not skip any of them.", kind: "data" },
