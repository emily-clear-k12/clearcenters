...
export const PUBLIC_CASE = {
  ...
  tagline: "The bug in the pond and the dragonfly above it must be two different bugs.",
  transmission: {
    claimHeadline: "The bug in the pond and the dragonfly above it must be two different bugs.",
  ...
  statements: [
    ...
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "They look so different, so they must be two different bugs.",
      correctVerdict: "False",
      reasonText: "They are not two different bugs. Every marked pond bug grew into a dragonfly with the same mark. It is one bug that changes a lot as it grows.",
