  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "An iron washer and a steel bolt both snap up onto the magnet arm as soon as it passes over them.",
      correctVerdict: "True",
    ...
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "A brass hinge and a scrap of aluminum siding stay on the belt without moving, even with the magnet arm right above them.",
      correctVerdict: "True",
    ...
    },
    {
      ...
      reasonText: "Only some metals, like iron and steel, respond to a magnet. A sorter that only uses a magnet would let the brass and aluminum ride right past.",
    },
  ],

  evidenceReadings: [
    { id: "iron_washer", label: "Iron washer test", reading: "An iron washer snaps up onto the magnet arm the instant it passes over.", kind: "data" },
    { id: "steel_bolt", label: "Steel bolt test", reading: "A steel bolt does the same thing and jumps up to the magnet arm right away.", kind: "data" },
    { id: "brass_hinge", label: "Brass hinge test", reading: "A brass hinge stays flat on the belt, even right under the magnet arm.", kind: "data" },
    ...
    { id: "magnetism_note", label: "Sorting line note", reading: "Magnetism is a physical property that only some metals have, like iron and steel.", kind: "data" },
    { id: "property_note", label: "Sorting line note", reading: "Scrap metal can be very different from piece to piece in properties like magnetism, density, and how well it conducts electricity.", kind: "data" },
    { id: "hinge_color_note", label: "Hinge note", reading: "The brass hinge had a greenish spot near one screw hole.", kind: "distractor" },
  ],
