...
export const PUBLIC_CASE = {
  ...
  tagline: "Magnets stick to every metal object.",
  transmission: {
  ...
  fieldReport: {
    ...
    notes: "The photo shows four objects tested with the bar magnet. Each one is right where it landed. The paper clip and the iron nail are still stuck to the magnet. They snapped over as soon as they got close. The crumpled aluminum foil and the copper penny sit apart from the magnet. Neither one moved at all. The plastic bottle cap sits off to the side by itself. It is not metal, so it was never part of the magnet test.",
  },
  ...
  statements: [
    {
      ...
      reasonText: "The aluminum foil and the copper penny did NOT move toward the magnet. So magnets do not stick to every metal.",
    ...
    },
    {
      ...
      correctVerdict: "True",
      reasonText: "The foil and penny stayed still. The paper clip and nail jumped to the magnet. That shows metals act in different ways.",
  ...
  evidenceReadings: [
    { id: "paperclip", label: "Paper clip", reading: "Snapped right to the magnet from about 2 cm away.", kind: "metal" },
    { id: "nail", label: "Iron nail", reading: "Pulled toward the magnet as soon as it got close.", kind: "metal" },
    { id: "foil", label: "Aluminum foil", reading: "Held flat against the magnet. Did not move at all.", kind: "metal" },
    { id: "penny", label: "Copper penny", reading: "Held flat against the magnet. Did not move at all.", kind: "metal" },
    { id: "cap", label: "Plastic cap", reading: "Not metal, so it was not part of the magnet test.", kind: "distractor" },
  ],
