...
export const PUBLIC_CASE = {
  ...
  tagline: "The plant grew so much bigger that it must be eating the soil right out of the pot.",
  transmission: {
    claimHeadline: "The plant grew so much bigger that it must be eating the soil right out of the pot.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The soil in the pot weighed almost the same before planting and after eight weeks of growth.",
      correctVerdict: "True",
      reasonText: "If the plant were eating the soil, the soil's weight should have dropped a lot more.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "A second sunflower got the same soil but no sunlight. It stayed small and pale.",
      correctVerdict: "True",
      reasonText: "This shows the plant needed sunlight, not soil, most of all to grow big.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "Plants make most of their own food from sunlight, water, and a gas in the air called carbon dioxide. They do not eat soil.",
    },
  ],
  ...
  evidenceReadings: [
    ...
    { id: "dark_plant_result", label: "No-sunlight plant", reading: "A second sunflower grown in the dark, in the same soil, stayed small and pale after eight weeks.", kind: "data" },
    { id: "light_plant_result", label: "Sunlight plant", reading: "The first sunflower, grown in sunlight in the same soil, grew tall and full after eight weeks.", kind: "data" },
    { id: "photosynthesis_note", label: "Science note", reading: "Producers like plants make their own food from sunlight, water, and carbon dioxide in the air.", kind: "data" },
    { id: "matter_cycle_note", label: "Science note", reading: "The soil lost a tiny bit of weight. That was mostly water and nutrients, not solid soil.", kind: "data" },
    { id: "pot_color_note", label: "Pot note", reading: "Both pots were the same orange clay color.", kind: "distractor" },
  ],
