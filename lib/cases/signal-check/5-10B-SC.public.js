...
export const PUBLIC_CASE = {
  ...
  tagline: "If you pile up enough mud and squish it hard enough, it will turn into solid rock by tomorrow.",
  transmission: {
    claimHeadline: "If you pile up enough mud and squish it hard enough, it will turn into solid rock by tomorrow.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "A jar of layered mud and sand, pressed hard by hand, is still soft and crumbly the next day.",
      correctVerdict: "True",
      reasonText: "Squishing hard for a short time was not enough to turn the mud into rock.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "Real sedimentary rock shows hundreds of thin, tightly packed layers. They took an estimated thousands of years to build up.",
      correctVerdict: "True",
      reasonText: "That many layers and that much time are direct evidence that real rock forms slowly.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "Sedimentary rock forms as layers of sediment are slowly buried, pressed, and cemented together over a very long time. It does not happen in a day.",
    },
  ],
  ...
  evidenceReadings: [
    ...
    { id: "formation_process_note", label: "Science note", reading: "Sedimentary rock forms as layers of sediment are slowly buried, pressed, and cemented together over a very long time.", kind: "data" },
    { id: "fossil_fuel_note", label: "Science note", reading: "Fossil fuels also form slowly. Buried plant and animal remains change under pressure and heat over millions of years.", kind: "data" },
