...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "Navy records in the archive list American sailors taken off U.S. ships between 1803 and 1812 and forced to serve in the British Navy. This practice was called impressment. At the same time, Britain was at war with Napoleon's France. British rules called 'Orders in Council' blocked American ships from trading with France and its allies, which hurt American merchants and shippers. A congressional summary from the time lists impressment and trade restrictions as the top reasons for declaring war in 1812. The archive also has a speech from a War Hawk congressman. He argued that a war with Britain could help the United States gain Canadian territory. That hope came up after anger over impressment and trade was already running high.",
  },
  ...
  statements: [
    {
      ...
      reasonText: "British impressment of sailors and trade restrictions were bigger, earlier causes than any land dispute.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      ...
      correctVerdict: "True",
      reasonText: "This practice, called impressment, was a direct, recorded cause. It had nothing to do with land.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "Some War Hawks in Congress wanted war so the U.S. could gain Canadian land, so land was the war's real cause.",
      correctVerdict: "Misleading",
      reasonText: "That hope was real, but it came after years of anger over impressment and trade restrictions had already built up.",
    },
    {
      id: "D",
      tag: "SIGNAL D",
      ...
      correctVerdict: "True",
      reasonText: "These restrictions kept American ships from trading freely and added to the reasons for war.",
    },
  ],

  evidenceReadings: [
    { id: "causes_summary", label: "Congressional causes summary", reading: "A congressional summary lists impressment and trade restrictions as the top reasons for declaring war in 1812.", kind: "document" },
    { id: "impressment_log", label: "Impressment record", reading: "Navy records list American sailors taken from U.S. ships and forced to serve in the British Navy from 1803 to 1812.", kind: "document" },
    { id: "warhawk_speech", label: "War Hawk speech", reading: "A speech from a War Hawk congressman argues that a war with Britain could help the U.S. gain Canadian territory.", kind: "document" },
    ...
    { id: "later_land_map", label: "1818 land treaty map", reading: "A land treaty map from 1818, drawn after the War of 1812 had already ended.", kind: "distractor" },
  ],
