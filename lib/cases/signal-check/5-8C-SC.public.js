...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "The photo shows a clear glass of water with a straight straw angled inside it. Right at the waterline the straw looks broken or shifted, even though a yellow pencil on the table reminds you the straw itself is rigid and straight. Looking from different angles moves where the 'bend' appears — a sign that light is refracting as it goes from air into water, not that the straw physically bent.",
  },
