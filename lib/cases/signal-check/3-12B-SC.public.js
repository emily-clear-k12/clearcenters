...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "The heron count held steady around 12–14 through late April, then dropped sharply right after the frog population drop on 5/11 — falling all the way to about 3 herons by early June. A note at the bottom of the log points out that herons also eat fish and insects.",
  },
