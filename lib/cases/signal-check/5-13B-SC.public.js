...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "This still is pulled from the training archive's \"sit\" clip — the dog holding a steady sit while its owner gives the flat-hand signal, treat in hand. What the full clip log shows is that this exact sit didn't happen the first time the command was ever given: the archive notes weeks of treat-based practice before the dog responded reliably to the signal. The paw-shake clip in the same archive tells a similar story — the trainer worked with the dog dozens of times before it would shake on cue.\n\nTwo other clips in the archive tell a different story. In the scent-trail clip, the dog tracks a trail correctly on the very first attempt, with no practice runs beforehand. In the doorbell clip, the dog barks the instant the bell rings — the very first time it has ever heard the sound, no training involved. Those two behaviors show up cold, with nothing taught first.",
  },
