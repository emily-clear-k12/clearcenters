...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    image: "/signal-check/5-8b-sc-field-report.jpg",
    imageCaption: "Motor Circuit Test — knife switch open",
    notes: "The photo shows a simple circuit on a wooden table: a battery holder, a knife-style switch with the lever raised (open), and a small motor. The wires still connect the parts. But with the switch open, the loop is broken, so the motor is not spinning. Closing that same switch completes the loop and lets electrical energy reach the motor.",
  },
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "With the switch OFF, the motor doesn't spin at all, even though every wire is still connected to the battery.",
      correctVerdict: "True",
      reasonText: "This shows a connected wire alone is not enough. The loop still has to be closed.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "The instant the switch flips ON, the motor starts spinning. It also feels a little warm after running for a minute.",
      correctVerdict: "True",
      reasonText: "This shows the electrical energy changes into both motion and a little thermal energy once the loop closes.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
  ...
  evidenceReadings: [
    ...
    { id: "wire_check_off", label: "Wire check, switch OFF", reading: "Every wire is still connected to the battery, even while the switch is OFF.", kind: "data" },
    ...
    { id: "motor_warm_check", label: "Motor temperature check", reading: "The spinning motor also feels a little warm after running for a minute.", kind: "data" },
    ...
    { id: "transform_note", label: "Science note", reading: "In this circuit, electrical energy changes into motion energy in the motor, plus a little thermal energy.", kind: "data" },
