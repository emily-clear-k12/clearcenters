...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "The photo shows a simple circuit on a wooden table: a battery holder, a knife-style switch with the lever raised (open), and a small DC motor. The wires still connect the parts, but with the switch open the loop is broken, so the motor isn't spinning. Closing that same switch completes the loop and lets electrical energy reach the motor.",
  },
