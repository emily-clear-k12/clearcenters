...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    image: "/signal-check/3-6e-sc-field-report.jpg",
    imageCaption: "Field Lab 3 — magnet test, five objects",
    notes: "The photo shows a red-and-silver bar magnet with a paper clip stuck to the red end and an iron nail resting across the magnet. Laid out separately to the right — not touching the magnet at all — are a crumpled ball of aluminum foil, a copper penny, and a plastic bottle cap. The paper clip and nail were pulled in the moment they got close. The foil and penny never moved. The plastic cap sits off to the side because it isn't metal.",
  },
