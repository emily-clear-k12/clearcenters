...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "The photo shows a tall metal pole on asphalt casting a long, sharp shadow across a semi-circle of painted white teardrop markers. The shadow lines up with one of the markers. Measuring at different times of day, and again the next day, shows the same predictable pattern — tied to Earth's rotation and the sun's apparent path — not a random wander.",
  },
