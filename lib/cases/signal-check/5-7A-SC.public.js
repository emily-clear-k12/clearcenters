...
export const PUBLIC_CASE = {
  ...
  statements: [
    ...
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "The rope's marked center point stays in the same spot the whole time, even while both teams pull hard.",
      correctVerdict: "True",
      reasonText: "No change in position, even with a lot of force on the rope, is direct evidence that the forces are balanced.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "Equal and opposite forces balance out and cause no change in motion, so the rope only moves once the forces become unequal.",
    },
  ],
