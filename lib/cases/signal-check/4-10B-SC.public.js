...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "Two weeks of trail camera photos from the same river bend tell a clear story. On Day 1, the inside curve was bare, with no rocks or gravel, just packed mud along the bank. By Day 14, a wide bar of gravel and small stones has built up at that same curve. It sits exactly where the current slows down. Upstream, the spot where that gravel used to sit is now empty. A lab comparison shows the rock type in the new bar matches the rock from upstream exactly. It is the same stone, just moved. In bright light, the rocks even shine and look brand new, but shine alone does not prove that.",
  },
  ...
  statements: [
    ...
    },
    {
      ...
      correctVerdict: "True",
      reasonText: "The upstream site is missing sediment that matches what piled up at the bank.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "Moving water can drop the sediment it carries when it slows down.",
      correctVerdict: "True",
      reasonText: "The current slows down at the inside curve, which is exactly where the sediment piled up.",
    },
  ],
