...
export const PUBLIC_CASE = {
  ...
  tagline: "The creek bank looks very different from last year. Something sudden must have happened overnight.",
  transmission: {
    claimHeadline: "The creek bank looks very different from last year. Something sudden must have happened overnight.",
  ...
  statements: [
    ...
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "This kind of change most often happens all at once, overnight.",
      correctVerdict: "False",
      reasonText: "Photos taken each week show the curve growing a little at a time. No big storm or flood was recorded.",
      stemEvidenceIds: ["weekly_log", "no_single_event"],
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "Small changes add up over a long time to make a big difference.",
      correctVerdict: "True",
      reasonText: "Add up all the weekly measurements. They match the full size of this year's curve.",
  ...
  evidenceReadings: [
    ...
    { id: "weekly_log", label: "Weekly photo log", reading: "Photos from the whole year show the curve growing a little each week.", kind: "data" },
    { id: "no_single_event", label: "Storm event log", reading: "No big storm or flood was recorded the week the curve first showed up.", kind: "data" },
    { id: "total_change", label: "Measurement total", reading: "All the weekly measurements add up to the full size of this year's curve.", kind: "data" },
    { id: "slow_current", label: "Current flow log", reading: "The moving water at that bend has slowly worn away the bank every week.", kind: "data" },
    { id: "bank_color", label: "Color note", reading: "The creek bank near the curve turned a little lighter tan this year.", kind: "distractor" },
  ],
