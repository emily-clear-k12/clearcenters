...
export const PUBLIC_CASE = {
  ...
  evidenceReadings: [
    { id: "model", label: "Fraction strips", reading: "Two strips are the same size. One has 6 of its 8 parts shaded. The other has 3 of its 4 parts shaded. The shaded parts are the same length.", kind: "data" },
