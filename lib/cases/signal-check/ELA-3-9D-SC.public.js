...
export const PUBLIC_CASE = {
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The title tells you what the article is mostly about.",
      correctVerdict: "Misleading",
      reasonText: "The title mentions honey, but only one sentence in the article is about honey.",
      stemEvidenceIds: ["title", "honey_line"],
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "Most of the paragraphs explain how bees help plants grow fruit.",
      correctVerdict: "True",
      reasonText: "The paragraphs explain how bees carry pollen and help apple trees make apples.",
    ...
    },
    {
      ...
      reasonText: "The paragraphs are about bees helping plants grow food, and the central idea is what most details are about.",
  ...
  evidenceReadings: [
    ...
    { id: "honey_line", label: "Honey sentence", reading: "Only one sentence in the article talks about honey.", kind: "data" },
    ...
    { id: "flower_pic", label: "Picture", reading: "The article has a picture of a flower.", kind: "distractor" },
  ],
