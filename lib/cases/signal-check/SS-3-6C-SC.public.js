...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "The third-grade class baked 40 cupcakes for their bake sale. Each cupcake cost $1.50 to make. But they sold each one for only $1.00. By 1:00, the table was empty. Someone said, \"They sold it all, so they must have made a profit!\"",
  },
  ...
  statements: [
    {
      ...
      correctVerdict: "True",
      reasonText: "The end-of-day log shows all 40 cupcakes sold. The class baked 40.",
    ...
    },
    {
      ...
      reasonText: "The totals show $40.00 came in, but the cupcakes cost $60.00 to make. Selling out did not stop the sale from losing money.",
      stemEvidenceIds: ["total_revenue", "total_cost"],
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "Each cupcake cost more to make than it sold for, so the sale lost money.",
      correctVerdict: "True",
      reasonText: "Each cupcake cost $1.50 to make but sold for only $1.00. Losing $0.50 on each one adds up over all 40.",
      stemEvidenceIds: ["cost_sheet", "price_sheet"],
    },
  ],

  evidenceReadings: [
    { id: "sold_out_log", label: "End of day log", reading: "All 40 cupcakes were sold. The table was empty by 1:00.", kind: "data" },
    { id: "cupcake_count", label: "Baking count", reading: "The class baked exactly 40 cupcakes for the sale.", kind: "data" },
    { id: "total_revenue", label: "Sales revenue tally", reading: "40 cupcakes sold at $1.00 each = $40.00 in all.", kind: "data" },
    { id: "total_cost", label: "Ingredient cost tally", reading: "40 cupcakes at $1.50 each to make = $60.00 in all.", kind: "data" },
