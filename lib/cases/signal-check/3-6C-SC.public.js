...
export const PUBLIC_CASE = {
  ...
  tagline: "This ice-cold can is leaking from the inside. That is the only way it could get wet.",
  transmission: {
    claimHeadline: "This ice-cold can is leaking from the inside. That is the only way it could get wet.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The can was sealed and never opened before the drops showed up.",
      correctVerdict: "True",
      reasonText: "The seal check and the tab check both show the can was never opened. It has no cracks or holes.",
    ...
    },
    {
      ...
      correctVerdict: "True",
      reasonText: "The drops are clear. The soda is dark brown. The colors do not match.",
    ...
    },
    {
      ...
      reasonText: "A warm can stayed dry. The cooling note says water in the air turns into drops on a cold surface. The can is not leaking at all.",
      stemEvidenceIds: ["warm_can_compare", "cooling_note"],
    },
  ],

  evidenceReadings: [
    { id: "sealed_check", label: "Seal check", reading: "The pull tab is still sealed. It was never opened.", kind: "data" },
    { id: "tab_check", label: "Surface inspection", reading: "No cracks or holes anywhere on the can.", kind: "data" },
    { id: "drop_color", label: "Drop sample", reading: "The drops on the outside of the can are clear, with no color at all.", kind: "data" },
    { id: "soda_color", label: "Soda sample", reading: "The soda inside the can is dark brown.", kind: "data" },
    { id: "warm_can_compare", label: "Warm can comparison", reading: "A closed can left out at room temperature stayed dry. It had no drops at all.", kind: "data" },
    { id: "cooling_note", label: "Cooling note", reading: "Water in the air turns into drops when it touches something much colder than the air.", kind: "data" },
    { id: "label_wear", label: "Label check", reading: "The can's label is starting to peel a little at one corner.", kind: "distractor" },
  ],
