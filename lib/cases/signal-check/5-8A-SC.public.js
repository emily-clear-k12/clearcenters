...
export const PUBLIC_CASE = {
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "A fresh battery's stored chemical energy reads high on the tester. A battery that has run the flashlight for hours reads much lower.",
      correctVerdict: "True",
      reasonText: "The battery's energy drops as the flashlight runs. That shows the light comes from somewhere, not from nothing.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "The flashlight bulb also warms up a little while it is lit, which shows thermal energy too, not just light.",
      correctVerdict: "True",
      reasonText: "Some of the battery's energy is turning into heat as well as light. That is more evidence of energy changing form, not being made from nothing.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "The flashlight transforms the battery's chemical energy into light and thermal energy. It does not create energy from nothing.",
    },
  ],
  ...
  evidenceReadings: [
    ...
    { id: "used_battery_reading", label: "Used battery reading", reading: "After running the flashlight for hours, the same battery reads much lower.", kind: "data" },
    { id: "bulb_temp_before", label: "Bulb temperature, at switch-on", reading: "The bulb feels like room temperature right when it is switched on.", kind: "data" },
    { id: "bulb_temp_after", label: "Bulb temperature, after minutes lit", reading: "The same bulb feels warm after staying lit for several minutes.", kind: "data" },
    { id: "energy_transform_note", label: "Science note", reading: "Energy does not appear from nothing. The flashlight transforms the battery's chemical energy into light and thermal energy.", kind: "data" },
    { id: "conservation_energy_note", label: "Science note", reading: "All the energy that leaves as light and heat came from the energy stored in the battery.", kind: "data" },
