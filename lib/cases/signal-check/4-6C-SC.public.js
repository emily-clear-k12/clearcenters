...
export const PUBLIC_CASE = {
  ...
  statements: [
    ...
    },
    {
      id: "C",
      tag: "SIGNAL C",
      text: "The mix measured less than 100 mL, so something must have spilled or disappeared.",
  ...
  evidenceReadings: [
    ...
    { id: "gap_note", label: "Science note", reading: "Small beans slide into the tiny gaps between the bigger rice grains. So the mix takes up less space than the two amounts added together.", kind: "data" },
