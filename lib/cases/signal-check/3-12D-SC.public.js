...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "A ruler next to the shape shows it's about 4 cm across and matches a real shell's ridges exactly. A magnifying glass zoomed in on the surface around it — the close-up shows no tool marks visible anywhere near the shape.",
  },
