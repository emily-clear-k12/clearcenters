...
export const PUBLIC_CASE = {
  ...
  tagline: "The moon gets smaller until it's almost gone, then grows all the way back. It must shrink and rebuild itself every month.",
  transmission: {
    claimHeadline: "The moon gets smaller until it's almost gone, then grows all the way back. It must shrink and rebuild itself every month.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The moon measures the same size in every photo this month, from a full circle to a thin sliver.",
      correctVerdict: "True",
    ...
    },
    {
      ...
      correctVerdict: "True",
      reasonText: "The moon's surface matches from night to night. It is the same moon the whole time, not something shrinking.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "The moon's size never changes. We just see a different part of it lit up as it moves around Earth.",
    },
  ],
  ...
  evidenceReadings: [
    ...
    { id: "feature_match_1", label: "Feature match, night 5", reading: "The same dark patch shows up in the same spot on the moon as on night 1.", kind: "data" },
    { id: "feature_match_2", label: "Feature match, night 20", reading: "The same craters line up in the same spot on the moon as on earlier nights.", kind: "data" },
    { id: "light_angle_note", label: "Science note", reading: "We can only see the part of the moon that is lit by sunlight and facing Earth.", kind: "data" },
    { id: "phase_pattern_note", label: "Science note", reading: "As the moon moves around Earth, the lit part we see changes shape. The pattern repeats every month.", kind: "data" },
    { id: "horizon_color_note", label: "Sky note", reading: "One night, the moon looked a little orange low in the sky.", kind: "distractor" },
  ],
