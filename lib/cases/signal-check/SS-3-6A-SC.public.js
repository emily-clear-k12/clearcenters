...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "The lemonade stand wrote down its price every day. On the hottest day, the price went up to $2 a cup. The stand sold out in an hour. On a cooler day, the price stayed at $1. Some cups were left over. One day, only six cups were left. The price went up to $2.50. That same week, the stand had a full pitcher one morning. The price stayed at $1. One time, the stand tried a price of $100 for one cup. Nobody bought it.",
  },
  ...
  statements: [
    {
      ...
      correctVerdict: "True",
      reasonText: "On the hottest day, the stand raised its price and still sold out fast. More people wanted lemonade, so the price went up.",
    ...
    },
    {
      ...
      correctVerdict: "True",
      reasonText: "When only a few cups were left, the price went up. On a morning with a full pitcher, it was lower.",
    ...
    },
    {
      ...
      reasonText: "When the stand tried a much higher price, nobody bought a cup.",
  ...
  evidenceReadings: [
    { id: "hot_day", label: "Saturday sales log", reading: "92°F outside. Price raised to $2 a cup. Sold out in an hour.", kind: "data" },
    { id: "cool_day", label: "Tuesday sales log", reading: "74°F outside. Price stayed at $1 a cup. Cups left over at closing.", kind: "data" },
    { id: "low_supply", label: "Sunday afternoon log", reading: "Only 6 cups left. Price raised to $2.50 a cup for the rest of the day.", kind: "data" },
    { id: "full_supply", label: "Sunday morning log", reading: "Just opened with a full pitcher. Price at $1 a cup.", kind: "data" },
    { id: "overprice_day", label: "Wednesday experiment", reading: "Price raised to $100 a cup for one hour. Zero cups sold.", kind: "data" },
    { id: "sign_color", label: "Price sign", reading: "The price sign was painted a new color that day. The price did not change.", kind: "distractor" },
  ],
