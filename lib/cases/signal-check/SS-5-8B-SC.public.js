...
export const PUBLIC_CASE = {
  ...
  fieldReport: {
    ...
    notes: "Public records show the finished dam giving the town irrigation water and electricity. Those are real, recorded benefits. But the first notice proposing the dam talks only about water and power. It does not mention the valley's farmland at all. Property records tell a fuller story. After the dam was built, several farms in the valley were flooded, and their families had to move. Fish population data shows a sharp drop downstream in the years after the dam went up. That hurt local fishers who depended on the fish to earn a living.",
  },
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "The dam gave the town a steady water supply for irrigation and a new source of electricity.",
      correctVerdict: "True",
      reasonText: "These are real, recorded benefits that the dam provided.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      ...
      reasonText: "Leaders talked up the benefits when they proposed the dam. They said little about the costs until building had started.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "Flooding the valley behind the dam destroyed farmland and forced several families to move.",
    },
    {
      id: "D",
      tag: "SIGNAL D",
      ...
      correctVerdict: "False",
      reasonText: "The changed water flow downstream hurt the fish that local fishers depended on to earn a living.",
    },
  ],

  evidenceReadings: [
    { id: "dam_benefits", label: "Dam benefits record", reading: "Public records show the finished dam giving the town irrigation water and electricity.", kind: "document" },
    { id: "proposal_notice", label: "Original dam proposal notice", reading: "The first dam proposal notice talks up water and power and does not mention the valley's farmland.", kind: "document" },
    { id: "flooded_farmland", label: "Flooded farmland records", reading: "Property records show several valley farms were flooded and their families moved after the dam was built.", kind: "document" },
    { id: "fish_data", label: "Downstream fish population data", reading: "Fish population data shows a sharp drop downstream in the years after the dam was built.", kind: "data" },
    { id: "unrelated_bridge", label: "Unrelated bridge repair record", reading: "A record of a bridge repair in a different town, with no link to the dam.", kind: "distractor" },
  ],
