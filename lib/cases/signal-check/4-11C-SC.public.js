...
export const PUBLIC_CASE = {
  ...
  tagline: "Rock is solid all the way through, so water or oil could never be stored inside it underground.",
  transmission: {
    claimHeadline: "Rock is solid all the way through, so water or oil could never be stored inside it underground.",
  ...
  statements: [
    {
      id: "A",
      tag: "SIGNAL A",
      text: "A sandstone sample soaks up a full cup of water in seconds. A granite sample lets almost none soak in.",
      correctVerdict: "True",
      reasonText: "This test side by side shows some rocks do let liquid soak in, and others do not.",
    },
    {
      id: "B",
      tag: "SIGNAL B",
      text: "Up close, the sandstone has tiny gaps between its grains. The granite has none.",
      correctVerdict: "True",
      reasonText: "Those tiny gaps are the spaces where water, oil, or gas can be stored inside some rocks.",
    },
    {
      id: "C",
      tag: "SIGNAL C",
      ...
      reasonText: "Some rocks, like sandstone, have tiny gaps that connect. They can hold liquids and even let them move through.",
    },
  ],

  evidenceReadings: [
    { id: "sandstone_soak", label: "Sandstone soak test", reading: "A sandstone sample soaks up a full cup of water in seconds.", kind: "data" },
    ...
    { id: "sandstone_zoom", label: "Sandstone close-up", reading: "Up close, the sandstone sample has tiny gaps between its grains.", kind: "data" },
    { id: "granite_zoom", label: "Granite close-up", reading: "Up close, the granite sample has tightly packed crystals with no gaps.", kind: "data" },
    { id: "porous_definition", label: "Science note", reading: "A rock with lots of tiny gaps that connect is called porous. It can hold liquids in those gaps.", kind: "data" },
    ...
    { id: "rock_color_note", label: "Rock note", reading: "The sandstone sample was light tan. The granite sample was gray.", kind: "distractor" },
  ],
