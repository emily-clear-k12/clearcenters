...
const LIBRARY = [
  ...
  { code: "RS.3.SS01", grade: 3, tier: "launch", topic: "ss", subject: "Social Studies", std: "Social Studies 3.4A (cardinal and intermediate directions)", title: "Finding Your Way",
    text: "A compass rose shows directions on a map. The four cardinal directions are north, south, east, and west. The intermediate directions are in between them: northeast, northwest, southeast, and southwest. We use directions to find places on a map and to give clear instructions." },
  ...
  { code: "RS.3.SS03", grade: 3, tier: "cruise", topic: "ss", subject: "Social Studies", std: "Social Studies 3.6B (scarcity)", title: "Scarcity and Choices",
    text: "Scarcity means there is not enough of something for everyone who wants it. People have many wants, but resources such as time, money, and materials are limited. Because of scarcity, people must make choices. If you have five dollars, you might have to choose between a book and a toy. When you choose one thing, you give up the other." },
  { code: "RS.3.SS04", grade: 3, tier: "orbit", topic: "ss", subject: "Social Studies", std: "Social Studies 3.9A, 3.9C (good citizenship, civic responsibility)", title: "Being a Good Citizen",
    text: "Good citizens help make their communities better places to live. They are honest, which means they tell the truth. They show respect for others, even when they disagree. They take responsibility for their own actions. Good citizens also follow rules and laws, such as crossing the street safely and throwing trash in the right place. Many good citizens volunteer their time to help others. They might pick up litter at a park, collect food for families in need, or read to younger students. When people vote, they help make decisions for the whole group. Every person can be a good citizen." },
  ...
  { code: "RS.4.SS04", grade: 4, tier: "orbit", topic: "ss", subject: "Social Studies", std: "Social Studies 4.4 (cattle industry and cattle drives)", title: "The Great Cattle Drives",
    text: "After the Civil War, there were millions of longhorn cattle in Texas, but beef sold for much more money in the North and East. To reach those markets, cowboys drove huge herds of cattle north along trails such as the Chisholm Trail. The trail led to railroad towns in Kansas, where the cattle were loaded onto trains. A cattle drive could last two or three months. Cowboys, including many African Americans and Mexican American vaqueros, worked long days in dust, heat, and storms. As railroads reached Texas and ranchers put up barbed wire fences, the great cattle drives came to an end." },
  ...
  { code: "RS.3.BIO03", grade: 3, tier: "cruise", topic: "bio", subject: "Social Studies", std: "Social Studies 3.9B (examples of good citizens)", title: "Ruby Bridges",
    text: "In 1960, six-year-old Ruby Bridges became the first Black student at William Frantz Elementary School in New Orleans. Many people shouted at her as she walked to school, so federal marshals walked beside her to keep her safe. Ruby was brave and kept going to school every day. Her courage helped open schools in the South to all children." },
  { code: "RS.3.BIO04", grade: 3, tier: "orbit", topic: "bio", subject: "Social Studies", std: "Social Studies 3.13A (scientists and inventors)", title: "Jonas Salk",
    text: "In the early 1950s, many parents were afraid of a disease called polio. Polio could make it hard for people to walk or even breathe, and it often affected children. A scientist named Jonas Salk worked for years in his laboratory to find a way to stop it. In 1955, his polio vaccine was announced as safe and effective. Soon, millions of children received the vaccine, and the number of polio cases dropped quickly. When a reporter asked Salk who owned the rights to the vaccine, he said it belonged to the people. He did not want to earn money from something that could help so many." },
  ...
  { code: "RS.4.BIO02", grade: 4, tier: "cruise", topic: "bio", subject: "Social Studies", std: "Social Studies 4.18A (Texas inventors), 4.4", title: "Joseph Glidden and Barbed Wire",
    text: "Joseph Glidden invented a kind of barbed wire in 1874. Barbed wire is wire with sharp points twisted around it. Before barbed wire, ranchers on the plains had few ways to fence in their cattle, because there were not many trees for wooden fences. Barbed wire was cheap and strong. It changed ranching in Texas and helped end the open range." },
  ...
  { code: "RS.4.BIO04", grade: 4, tier: "orbit", topic: "bio", subject: "Social Studies", std: "Social Studies 4.18A (Texas scientists)", title: "Michael DeBakey",
    text: "Michael DeBakey was a heart surgeon who worked in Houston for many years. As a young medical student, he invented a pump that could keep blood moving during surgery. This roller pump later became an important part of the heart-lung machine. During World War II, he helped plan mobile army surgical hospitals, which moved close to the battlefield to treat wounded soldiers faster. At Baylor College of Medicine in Houston, DeBakey and his team developed new ways to repair and replace damaged blood vessels. Over his long career, he performed more than sixty thousand operations and trained surgeons from around the world." },
  ...
  { code: "RS.5.BIO04", grade: 5, tier: "orbit", topic: "bio", subject: "Social Studies", std: "Social Studies 5.22A (science and technology in U.S. history)", title: "Neil Armstrong",
    text: "On July 16, 1969, the Apollo 11 spacecraft launched from Florida with three astronauts aboard: Neil Armstrong, Buzz Aldrin, and Michael Collins. Four days later, Armstrong and Aldrin landed on the Moon in a small spacecraft called the Eagle, while Collins stayed in orbit. Millions of people watched on television as Armstrong climbed down the ladder. When he stepped onto the dusty surface, he said, \"That's one small step for man, one giant leap for mankind.\" Armstrong and Aldrin collected rocks and set up experiments before returning safely to Earth. Their mission showed that careful planning and teamwork could make an impossible dream come true." },
  ...
  { code: "RS.3.ELA04", grade: 3, tier: "orbit", topic: "ela", subject: "ELAR", std: "ELAR 3.12B (informational text)", title: "News Brief: Bake Sale Helps Shelter",
    text: "Third Graders Raise Money for Animal Shelter\n\nOn Friday, the third graders at Oak Hill Elementary held a bake sale to help the local animal shelter. Students baked cookies, muffins, and brownies at home and sold them in the cafeteria after lunch. By the end of the day, they had raised enough money to buy food, blankets, and toys for the dogs and cats at the shelter. \"We wanted to help animals who do not have a home yet,\" said student Maya Lopez. The shelter director thanked the class and invited everyone to visit next month to meet the animals." },
