...
export const SERVER_CASE = {
  ...
  checkpoints: [
    ...
    { id: "fair", type: "mc", correctChoiceId: "distance", sceneOnly: true },
  ...
  feedback: {
    cp1: {
      yes: "Yes! The farther away the magnet, the fewer paperclips it picks up. Your dots slide down as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the distance changed. The magnet, the paperclips and the table stayed the same — that makes it a fair test.",
      hint: "Hmm, that one stayed the same every run. What did you change when you moved the magnet?",
    },
  },
