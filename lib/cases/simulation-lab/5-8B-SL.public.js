...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "fan", text: "Which fan blade we used", icon: "fan" },
        { id: "batteries", text: "How many batteries were in the circuit", icon: "battery" },
        { id: "motor", text: "Which motor we used", icon: "motor" },
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/motor.js).
  ...
  scene: {
    ...
    twist: {
      ...
      question: "The fan blade is bigger now. Does your pattern still hold?",
    },
  },
