...
export const SERVER_CASE = {
  ...
  checkpoints: [
    ...
    { id: "fair", type: "mc", correctChoiceId: "rough", sceneOnly: true },
  ...
  feedback: {
    cp1: {
      yes: "Yes! A rougher surface stops the block sooner — a shorter slide. Your dots slide down as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the roughness changed. The block, the spring’s push and the start line stayed the same — that makes it a fair test.",
      hint: "Hmm, that one stayed the same every run. What did you change when you picked a surface?",
    },
  },
