...
export const SERVER_CASE = {
  ...
  checkpoints: [
    ...
    { id: "fair", type: "mc", correctChoiceId: "breaths", sceneOnly: true },
  ],
  ...
  feedback: {
    cp1: {
      yes: "Yes! More breaths, more distance — your dots climb as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the breaths changed. The balloon, the string track, and the launch point stayed the same — that makes it a fair test.",
      hint: "Hmm, that one stayed the same every run. What did you change with the pump?",
    },
  },
