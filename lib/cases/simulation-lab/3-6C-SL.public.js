...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "cube", text: "How big the ice cube was", icon: "ice" },
        { id: "heat", text: "How hot the heat lamp was", icon: "lamp" },
        { id: "tray", text: "Which tray the ice sat on", icon: "tray" },
        { id: "far", text: "How far away the lamp was", icon: "distance" },
      ],
    },
    {
      id: "cp2",
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/ice.js).
