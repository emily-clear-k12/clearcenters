...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "bulb", text: "Which bulb we used", icon: "bulb" },
        { id: "batteries", text: "How many batteries were in the circuit", icon: "battery" },
        { id: "wires", text: "Which wires we used", icon: "wire" },
        { id: "switch", text: "Which switch we used", icon: "switch" },
      ],
    },
    {
      id: "cp2",
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/bulb.js).
  ...
  scene: {
    ...
    unit: "units",
    unitOne: "unit",
    outcomeAxis: "Brightness",
    variableAxis: "Batteries",
    checkpointIds: ["cp1", "fair"],
    choiceIcons: { cp1: { increase: "up", decrease: "down", same: "flat" } },
    twist: {
      type: "biggerBulb",
      banner: "Conditions change!",
      question: "The bulb is bigger now. Does your pattern still hold?",
    },
  },
