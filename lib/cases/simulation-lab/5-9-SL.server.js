...
export const SERVER_CASE = {
  ...
  checkpoints: [
    ...
    { id: "fair", type: "mc", correctChoiceId: "time", sceneOnly: true },
  ...
  feedback: {
    cp1: {
      yes: "Yes! As the morning goes on and the Sun climbs higher, the shadow gets shorter. Your dots slide down as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the time of morning changed. The stick, its spot and the ruler stayed the same — that makes it a fair test.",
      hint: "Hmm, that one stayed the same every run. What did you change when you moved the Sun?",
    },
  },
