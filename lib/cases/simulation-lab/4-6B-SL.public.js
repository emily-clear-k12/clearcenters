...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "water", text: "How much water was in the beaker", icon: "water" },
        { id: "temp", text: "How hot the water was", icon: "thermo" },
        { id: "sugar", text: "What kind of sugar we used", icon: "sugar" },
        { id: "stir", text: "How long we stirred", icon: "spoon" },
      ],
    },
    {
      id: "cp2",
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/dissolve.js).
  ...
  scene: {
    ...
    unitOne: "g",
    outcomeAxis: "Grams",
    variableAxis: "Water temperature (°C)",
    checkpointIds: ["cp1", "fair"],
    choiceIcons: { cp1: { increase: "up", decrease: "down", same: "flat" } },
    twist: {
      type: "salt",
      banner: "Conditions change!",
      question: "It’s salt instead of sugar now. Does your pattern still hold?",
    },
  },
