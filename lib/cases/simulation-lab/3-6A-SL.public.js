...
// selfCheckQuestions) — the Simulation Lab engine is fully schema-driven, so
...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "boat", text: "Which boat we used", icon: "boat" },
        { id: "washers", text: "How many washers we loaded", icon: "washers" },
        { id: "water", text: "How much water was in the tank", icon: "water" },
        { id: "tank", text: "Which tank we used", icon: "tank" },
      ],
    },
    {
      id: "cp2",
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/boat.js).
  ...
  scene: {
    ...
    snap: 1,
    unit: "cm",
    outcomeAxis: "Space (cm)",
    variableAxis: "Washers",
