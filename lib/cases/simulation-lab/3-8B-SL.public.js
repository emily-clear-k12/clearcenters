...
export const PUBLIC_CASE = {
  ...
  pretrialSteps: {
    ...
    chooseVariables: {
      ...
      testing: "Ramp Angle — the one thing you'll change.",
      imageUrl: null,
    },
    hypothesis: {
  ...
  responseStems: [
    ...
    "Even after the ball got heavier, the pattern ___.",
    "A steeper ramp gives the ball more ___, so it rolls farther.",
  ],

  generalizePrompt:
    "You've run trials with two different balls now — explain the pattern you found. What happens to the distance the ball rolls as the ramp gets steeper? Back it up with real trials from your own log (an angle you tried and the distance you saw, from either round).",
  ...
  selfCheckQuestions: [
    ...
    "I said whether the pattern stayed the same after the ball got heavier.",
