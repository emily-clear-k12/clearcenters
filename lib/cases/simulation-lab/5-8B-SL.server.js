...
export const SERVER_CASE = {
  ...
  checkpoints: [
    ...
    { id: "fair", type: "mc", correctChoiceId: "batteries", sceneOnly: true },
  ...
  feedback: {
    cp1: {
      yes: "Yes! More batteries, a faster motor. Your dots climb as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the number of batteries changed. The motor, the fan blade and the wires stayed the same — that makes it a fair test.",
