...
export const SERVER_CASE = {
  ...
  feedback: {
    cp1: {
      yes: "Yes! More batteries, a brighter bulb. Your dots climb as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the number of batteries changed. The bulb, the wires and the switch stayed the same — that makes it a fair test.",
