...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "stick", text: "Which stick we measured", icon: "stick" },
        { id: "time", text: "What time of morning it was", icon: "clock" },
        { id: "place", text: "Where we stood the stick", icon: "start" },
        { id: "ruler", text: "Which ruler we used", icon: "ruler" },
      ],
    },
    {
      id: "cp2",
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/shadow.js).
  ...
  scene: {
    ...
    twist: {
      ...
      question: "Now it’s a tall flagpole. Does your pattern still hold?",
    },
  },
