...
//
// Shape mirrors the grade-3 cases exactly — the Simulation Lab engine is
...
export const PUBLIC_CASE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      choices: [
        { id: "block", text: "Which block we used", icon: "block" },
        { id: "rough", text: "How rough the surface was", icon: "rough" },
        { id: "push", text: "How hard the spring pushed", icon: "spring" },
        { id: "start", text: "Where the block started", icon: "start" },
      ],
    },
    {
      id: "cp2",
  ...
  // Animated Simulation Lab scene (components/simulation-lab/scenes/friction.js).
  ...
  scene: {
    ...
    snap: 1,
    unit: "cm",
    outcomeAxis: "Centimeters",
    variableAxis: "Roughness level",
    ghostFormat: "Level {v}",
    unitWord: "level",
    ...
    twist: {
      ...
      question: "The block is heavier now. Does your pattern still hold?",
    },
  },
