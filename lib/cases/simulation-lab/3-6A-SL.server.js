...
export const SERVER_CASE = {
  ...
  checkpoints: [
    ...
    { id: "fair", type: "mc", correctChoiceId: "washers", sceneOnly: true },
  ...
  feedback: {
    cp1: {
      yes: "Yes! More washers, less space above the water — your dots slide down as you go right.",
      hint: "Look again: follow your dots from left to right. Do they climb, drop, or stay level?",
    },
    fair: {
      yes: "Right! Only the number of washers changed. The boat, the tank and the water stayed the same — that makes it a fair test.",
      hint: "Hmm, that one stayed the same every run. What did you change with the + and − buttons?",
    },
  },
