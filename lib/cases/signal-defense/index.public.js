...
// Sept 16, 2026 — first grade 4 bank, a pilot for the grade 4/5 expansion.
// Registered so it can be previewed and played; it still needs a row in the
// `cases` table before it shows up in the Challenge Library (see
// add_signal_defense_4_10B.sql).
import { PUBLIC_CASE as CASE_4_10B_SD } from "./4-10B-SD.public";
import { PUBLIC_CASE as CASE_4_6A_SD } from "./4-6A-SD.public";
import { PUBLIC_CASE as CASE_4_6B_SD } from "./4-6B-SD.public";
import { PUBLIC_CASE as CASE_4_7A_SD } from "./4-7A-SD.public";
import { PUBLIC_CASE as CASE_4_6C_SD } from "./4-6C-SD.public";
import { PUBLIC_CASE as CASE_4_8A_SD } from "./4-8A-SD.public";
import { PUBLIC_CASE as CASE_4_8B_SD } from "./4-8B-SD.public";
import { PUBLIC_CASE as CASE_4_8C_SD } from "./4-8C-SD.public";
import { PUBLIC_CASE as CASE_4_9A_SD } from "./4-9A-SD.public";
import { PUBLIC_CASE as CASE_4_9B_SD } from "./4-9B-SD.public";
import { PUBLIC_CASE as CASE_4_10A_SD } from "./4-10A-SD.public";
import { PUBLIC_CASE as CASE_4_10C_SD } from "./4-10C-SD.public";
...
const CASES = {
  ...
  "4.10B-SD": CASE_4_10B_SD,
  "4.6A-SD": CASE_4_6A_SD,
  "4.6B-SD": CASE_4_6B_SD,
  "4.7A-SD": CASE_4_7A_SD,
  "4.6C-SD": CASE_4_6C_SD,
  "4.8A-SD": CASE_4_8A_SD,
  "4.8B-SD": CASE_4_8B_SD,
  "4.8C-SD": CASE_4_8C_SD,
  "4.9A-SD": CASE_4_9A_SD,
  "4.9B-SD": CASE_4_9B_SD,
  "4.10A-SD": CASE_4_10A_SD,
  "4.10C-SD": CASE_4_10C_SD,
};
