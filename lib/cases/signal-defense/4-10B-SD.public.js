...
// erosion from deposition when all three are in one scenario, and reading a
// cause-and-effect chain rather than a single fact. Question text is kept to
// roughly the grade-3 length, since these are read under time pressure in a
// live whole-class round.
//
...
export const PUBLIC_CASE = {
  ...
  questions: [
    ...
    },
    {
      "id": "4.10B-5",
      "type": "multiple_choice",
      "title": "Which of these moves weathered material from one place to another?",
      "prompt": "Choose the best answer.",
      "choices": [
        "Sunlight",
        "Gravity",
    ...
    },
    {
      ...
      "choices": [
        ...
        "Gravity pulling soil down a steep slope",
