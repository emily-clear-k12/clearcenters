...
7. **Add to Daily Focus** → writes `ci2.teacher.addedActivities` for today (`d=2`)
8. Open **Daily Focus** → tile appears (same browser)
9. **Add to This Week** → same planner extras key; open **This Week** to see it
...
## Files
- `lib/v2/demoLibrary.js` — demo cards (+ `standard`) + add / remove helpers + `libraryStandardChip`
