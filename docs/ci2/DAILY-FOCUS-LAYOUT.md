...
1. **Top full width (short):** SAM morning + SAM glance (max 3 needs) + period/subject switcher (+ RoomCards when multi-class)
...
2. **Top band:** SAM morning (Dismiss today) · SAM glance (≤3) · period chips · Setup switcher
