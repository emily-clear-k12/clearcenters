    ...
    <div style={{ display: "flex", minHeight: "100vh", background: COLORS.canvas, fontFamily: "'Inter', sans-serif", color: COLORS.textDark }}>
      ...
      <main style={{ flex: 1, padding: "32px 36px", maxWidth: 900, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ background: COLORS.white, border: `1px solid ${COLORS.border}`, borderRadius: 20, padding: 48, textAlign: "center", boxShadow: "0 4px 16px rgba(13,27,42,.06)", maxWidth: 480 }}>
          <img src="/teacher/nav_reports.png" alt="" style={{ width: 56, height: 56, objectFit: "contain", marginBottom: 16 }} />
          <h1 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: 24, margin: "0 0 10px 0" }}>Reports</h1>
          <p style={{ color: COLORS.textMuted, fontSize: 14.5, lineHeight: 1.6, margin: "0 0 18px 0" }}>Class-wide and per-student reports you can generate and export.</p>
