...
function topicLine(c){const label=missionMapTeksLabel(c.standard)||'';if(label.includes('—'))return label.split('—').slice(1).join('—').trim();return c.learning_target||'';}
